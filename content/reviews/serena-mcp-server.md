...
description: "Serena is an MCP server that gives AI coding agents semantic, symbol-level code understanding via Language Server Protocol and JetBrains integration. 24.4K GitHub stars, MIT license, 40+ language support — a step up from text-based code manipulation."
og_description: "Serena MCP: semantic code tools for AI agents via LSP and JetBrains. 24.4K stars, v1.5.1, MIT, 40+ languages, 19K/week PyPI downloads. Rating: 4/5."
content_type: "Review"

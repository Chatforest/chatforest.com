---
title: "UI-TARS Desktop — ByteDance's Open-Source Multimodal AI Agent Stack"
date: 2026-04-20T23:45:00+09:00
description: "UI-TARS Desktop is ByteDance's open-source multimodal AI agent platform that can see and control your computer screen. 29.5K GitHub stars, Apache-2.0 license, ships with built-in MCP servers for browser, filesystem, commands, and search."
og_description: "UI-TARS Desktop: ByteDance's multimodal GUI agent with built-in MCP servers. 29.5K stars, Apache-2.0, vision-language computer control. Rating: 3/5."
content_type: "Review"
card_description: "Open-source multimodal AI agent stack from ByteDance that controls your computer through vision-language models. Ships as two components: UI-TARS Desktop (Electron app for screen-based GUI control) and Agent TARS (CLI/Web UI for browser automation). Built on MCP protocol with bundled MCP servers for browser automation, filesystem operations, shell commands, and search. Supports remote computer and browser operators. 29.5K GitHub stars, 2.9K forks."

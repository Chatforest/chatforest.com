...
description: "Anthropic's official Git MCP server gives AI agents local git operations — status, diff, commit, branch. But with no push, pull, or merge, it's half a workflow. Three CVEs patched in late 2025. Tool annotations and injection guards added March 2026."
og_description: "Anthropic's official Git MCP server: 12 tools for local git operations, ~534K weekly PyPI downloads, 4.6M PulseMCP all-time (#12 globally). No push, pull, or merge. Rating: 3/5."
content_type: "Review"
card_description: "Anthropic's official reference Git MCP server — 12 tools for status, diff, commit, and branch operations. Massive adoption (4.6M PulseMCP visitors) but missing push, pull, merge, and remote operations entirely."

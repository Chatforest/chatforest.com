---
title: "Jeff Bezos Is Building 'The CAD of the Future' — And It Has Nothing to Do With Robotics"
date: 2026-05-24
description: "Project Prometheus, Jeff Bezos's first startup since leaving Amazon, is building an 'artificial general engineer' — AI that designs physical objects. Here's what we actually know about the most secretive $38B company in Silicon Valley."
og_description: "Jeff Bezos describes Project Prometheus for the first time: an 'artificial general engineer' that is a 'very, very modern version of CAD.' $16.2B raised. $38B valuation. 120 employees. JPMorgan and BlackRock as investors. Focus: aerospace, automotive, manufacturing, drug discovery. Separately: a $100B fund to acquire and rebuild old factories with the technology."
content_type: "Review"
card_description: "Jeff Bezos's first operational role since leaving Amazon is running Project Prometheus — an AI startup building what he calls 'a very, very modern version of CAD.' Not robots. Not chatbots. Physical AI: foundation models trained on real-world engineering data to help humans design things that get made. The company has raised $16.2B total, is valued at $38B, and counts JPMorgan and BlackRock as investors. On May 20, Bezos went on CNBC for the first time to talk about it — and was very clear about one thing: when the interviewer called it 'AI robotics,' Bezos stopped him cold."
tags: ["jeff-bezos", "project-prometheus", "physical-ai", "manufacturing", "world-models", "ai-funding", "general-agents", "engineering-ai", "industrial-ai"]
categories: ["reviews"]
author: "ChatForest"
---

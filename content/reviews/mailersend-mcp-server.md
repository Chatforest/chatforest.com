...
description: "MailerSend's official MCP server gives AI agents 38 tools for sending emails, managing domains, configuring webhooks, verifying addresses, and pulling analytics — all through natural language."
og_description: "MailerSend MCP: 38 tools for email, domains, webhooks, verification, analytics. Cloud-hosted, Streamable HTTP, OAuth. Rating: 4/5."
content_type: "Review"
card_description: "Official first-party cloud-hosted MCP server for MailerSend's transactional email platform. 38 tools covering email sending, domain management, webhook configuration, email verification, template management, and analytics. Streamable HTTP transport, OAuth authentication, beta status."

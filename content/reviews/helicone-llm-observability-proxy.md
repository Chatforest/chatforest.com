---
title: "Helicone — Proxy-Based LLM Observability (Acquired, Maintenance Mode)"
date: 2026-05-06T22:45:00+09:00
description: "Helicone reviewed: proxy-based LLM observability acquired by Mintlify in March 2026, now in maintenance mode. 5.6K stars, Apache 2.0, TypeScript. URL-only integration — no SDK needed. Rating: 3/5."
og_description: "Helicone (Helicone/helicone, ~5.6K stars, Apache 2.0, TypeScript) is a proxy-based LLM observability tool that requires only a URL change to integrate — no SDK instrumentation. Features cost tracking, caching, rate limiting, prompt management, and an MCP server. YC W23; processed 14.2 trillion tokens across 16,000+ organizations before being acquired by Mintlify on March 3, 2026. Now in maintenance mode. Self-hosting via single Docker container. Rating: 3/5."
card_description: "Helicone (Helicone/helicone, ~5.6K stars, Apache 2.0, TypeScript) integrates as a proxy — change one URL, add one header, and every LLM API call is logged. Features cost tracking, latency, caching, rate limiting, prompt management, and an MCP server. YC W23, San Francisco. Acquired by Mintlify on March 3, 2026; now in maintenance mode with no new feature development. Last release: v2025.08.21-1. Processed 14.2T tokens across 16K+ orgs before acquisition. Free tier: 10K requests/month, 7-day retention. Note: active alternatives (Langfuse, Arize Phoenix) are better choices for new projects. Part of our **Developer Tools** category. Rating: 3/5."

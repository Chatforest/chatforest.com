...
description: "Calendar and scheduling MCP servers are giving AI assistants direct access to event management, availability checking, and meeting coordination."
og_description: "Calendar & Scheduling MCP servers: Google now has an official Calendar MCP (Developer Preview, 8 tools), google_workspace_mcp doubled to 2,400 stars (v1.21.0, JWT OAuth), Microsoft Agent 365 went GA (May 1), Softeria 720 stars 200+ tools security-hardened, Calendly hosted MCP confirmed, temporal-cortex atomic booking NEW, CVE-2026-26118 SSRF (CVSS 8.8), CVE-2026-30623 MCP SDK RCE. Rating: 4.0→4.5/5."
content_type: "Review"

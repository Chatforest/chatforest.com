---
title: "LTX Video (Lightricks): The Open-Weight Video Model That Added Audio First"
date: 2026-05-11
lastmod: 2026-05-11
draft: false
tags: ["video generation", "text-to-video", "image-to-video", "open-source", "open-weight", "audio-video", "developer tools", "comfyui", "diffusion transformer"]
categories: ["reviews"]
description: "Lightricks — the Facetune company — built LTX Video, the first open-weight video model with native synchronized audio generation. With 22B parameters, 1.73M monthly HuggingFace downloads, and a ComfyUI ecosystem, it's the most technically ambitious open-weight video model available."
rating: 4
mcp_server: false
api_available: true
free_tier: true
pricing_model: "open-weight / cloud API / SaaS"
company_hq: "Jerusalem, Israel"
founded: 2013
---

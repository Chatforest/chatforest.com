...
lastmod: 2026-04-29T18:30:00+09:00
...
og_description: "Context7 delivers version-specific library docs to AI coding agents. 54.1K GitHub stars, 15.1M all-time PulseMCP visitors, ThoughtWorks Technology Radar Trial — but research mode shipped and partially reverted in a week, and growing competition from Nia and Docfork. Rating: 3.5/5."
content_type: "Review"
...
The fix is simple. When your agent needs to use a library, Context7 fetches the current, version-specific documentation and [injects it directly into the prompt](https://upstash.com/blog/context7-mcp). No tab-switching, no copy-pasting from docs sites, no outdated code generation. With [54,100 GitHub stars](https://github.com/upstash/context7), 2,600 forks, [15.1 million all-time PulseMCP visitors](https://www.pulsemcp.com/servers/upstash-context7), and a growing ecosystem that now includes a CLI, a VS Code extension, Codex support, OpenAI Apps SDK integration, and a Skills-based plugin system, it's achieved the kind of adoption most MCP servers dream about.

**At a glance:** 54.1K stars, 2.6K forks, 109 open issues, MCP server [v2.2.2](https://github.com/upstash/context7/releases) (April 28, 2026), CLI [ctx7 v0.4.0](https://github.com/upstash/context7/releases) (April 24, 2026), 69 total releases, 798 commits
...
Since our original review on March 14, Context7 has shipped steadily — [69 total releases](https://github.com/upstash/context7/releases) and counting, with four new releases in the last week alone.

**Research mode shipped and partially reverted.** The biggest feature attempt since our last update: [v2.2.0](https://github.com/upstash/context7/releases) and [ctx7 v0.4.0](https://github.com/upstash/context7/releases) (April 24) introduced a "research mode" — a `researchMode` tool exposed through MCP and a CLI `--research` flag for deeper, agent-driven documentation answers. Four days later, [v2.2.2](https://github.com/upstash/context7/releases) (April 28) removed the `researchMode` parameter from the `query-docs` tool to prevent timeout issues. The CLI `--research` flag remains, but the MCP-level integration was pulled. This rapid ship-and-revert cycle — a major feature added and partially undone within a week — suggests the team is moving fast but occasionally faster than their infrastructure can support.
...
**CLI v0.4.0 — lifecycle management.** Beyond research mode, [ctx7 v0.4.0](https://github.com/upstash/context7/releases) (April 24) added CLI update notifications, a `ctx7 upgrade` command for self-updating, and a `ctx7 remove` cleanup command with safer detection. These are table-stakes CLI features but show the tool maturing beyond just documentation queries.
...
**Growth continues but weekly momentum dips.** Stars climbed from 48,900 to [54,100](https://github.com/upstash/context7) (+800 in the last week alone). Forks grew to [2,600](https://github.com/upstash/context7). Open issues ticked back up from 105 to [109](https://github.com/upstash/context7) — the team may be losing ground again after briefly catching up. [PulseMCP](https://www.pulsemcp.com/servers/upstash-context7) now shows 15.1M all-time visitors (up from 13.9M), but weekly visitors dipped from 1M to 747K and the weekly ranking dropped from #3 to #7 — suggesting competitors are drawing attention. Total commits: 798.

**Alternatives are catching up — with receipts.** [Multiple comparison articles](https://dev.to/moshe_io/top-7-mcp-alternatives-for-context7-in-2026-2555) now track the competitive landscape. [Nia published a direct comparison](https://www.trynia.ai/blog/nia-vs-context7) claiming a 52.1% hallucination rate vs. Context7's 63.4% on bleeding-edge features — an 11.3 percentage point improvement from indexing source code directly rather than just documentation snippets. Docfork grew to [471 stars](https://github.com/docfork/docfork) (up from ~324), with 9,000+ libraries, MIT license, and Cabinets for context isolation, offering [single-call responses vs. Context7's two-step process](https://neuledge.com/blog/2026-02-06/top-7-mcp-alternatives-for-context7-in-2026). [Deepcon claims 90% accuracy vs. Context7's 65%](https://neuledge.com/blog/2026-02-06/top-7-mcp-alternatives-for-context7-in-2026) across 20 real-world scenarios. DeepWiki offers architectural understanding rather than raw docs. The competitive landscape is no longer just broadening — competitors are publishing head-to-head benchmarks.
...
**Active development.** [54,100 GitHub stars](https://github.com/upstash/context7), 2,600 forks, [69 releases](https://github.com/upstash/context7/releases) (798 total commits). Upstash is a real company (they also build Redis and Kafka-as-a-service) with an incentive to maintain this. This isn't a weekend project that'll be abandoned — and [ThoughtWorks agrees](https://www.thoughtworks.com/radar/tools/context7), placing it in their Technology Radar "Trial" ring with a recommendation that enterprises should try it.
...
With [109 open GitHub issues](https://github.com/upstash/context7) (briefly down to 105 from 148 in March, but climbing again), connection problems are a recurring theme:
...
The competitive landscape is also shifting — and competitors are now publishing head-to-head benchmarks. [Nia claims 52.1% hallucination rate vs. Context7's 63.4%](https://www.trynia.ai/blog/nia-vs-context7) by indexing source code directly. [Deepcon claims 90% accuracy vs. Context7's 65%](https://neuledge.com/blog/2026-02-06/top-7-mcp-alternatives-for-context7-in-2026). Docfork grew to [471 stars](https://github.com/docfork/docfork) with Cabinets for context isolation and [faster single-call responses](https://neuledge.com/blog/2026-02-06/top-7-mcp-alternatives-for-context7-in-2026). Context7's weekly PulseMCP ranking dropped from #3 to [#7](https://www.pulsemcp.com/servers/upstash-context7), suggesting attention is diversifying. The "must-use" case for Context7 is less clear than it was even a month ago.

The rating: **3.5 out of 5.** Context7 is the most accessible documentation MCP server available. The problem it solves is genuine, the execution is mostly good, and the adoption numbers are real — [54,100 stars](https://github.com/upstash/context7), [15.1M all-time PulseMCP visitors](https://www.pulsemcp.com/servers/upstash-context7), [69 releases](https://github.com/upstash/context7/releases). The hidden infrastructure ([65% token reduction](https://handsonarchitects.com/blog/2026/what-makes-mcp-server-successful/), DiskANN vector search, server-side reranking) is more sophisticated than the two-tool surface suggests. But the security history, aggressive monetization shift, unverified documentation quality, feature stability concerns (research mode revert), and growing competition with published benchmarks prevent it from scoring higher. Developers who care about supply chain security should look at Docfork or GitMCP; developers who want lower hallucination rates should evaluate Nia or Deepcon.

---
title: "Google Gemini 3.1 Flash TTS Review — Prompt-Steerable Speech with 30 Voices and 100+ Languages"
date: 2026-05-15T12:00:00+09:00
description: "Gemini 3.1 Flash TTS launched April 15, 2026 as a Preview model offering prompt-steerable text-to-speech, inline audio tags for expressive control, 30 prebuilt voices, 100+ auto-detected languages, and $1.00/$20.00 per million token pricing — with no native streaming and PCM-only output."
og_description: "Google's Gemini 3.1 Flash TTS uses natural-language prompts and inline audio tags instead of SSML. 30 voices, 100+ languages, $0.03/minute output cost, but PCM-only and no streaming. Preview status as of May 2026. Rating: 3.5/5."
content_type: "Review"
card_description: "Gemini 3.1 Flash TTS replaces XML-based SSML control with natural-language prompts and inline audio tags like [whispers] or [laughs]. 30 astronomically-named voices, 100+ languages auto-detected, $1.00/$20.00 per million tokens, PCM-only output at 24kHz. A genuinely different approach to expressive TTS — still in Preview."
last_refreshed: 2026-05-15
tags: ["tts", "speech", "google", "api", "multimodal", "audio"]
categories: ["reviews"]
rating: 3.5
author: "ChatForest"
---

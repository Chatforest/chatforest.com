...
description: "Claude Opus 4.7 (April 16, 2026) is Anthropic's current flagship — 87.6% SWE-bench Verified, 64.3% SWE-bench Pro, 36% hallucination rate on AA-Omniscience. Extended thinking is gone; Adaptive Thinking is in. And above Opus 4.7 sits Mythos: a more capable model Anthropic deliberately withheld due to cybersecurity safety concerns."
og_description: "Claude Opus 4.7 (April 16, 2026): SWE-bench Verified 87.6%, SWE-bench Pro 64.3% (+10.9 pts over Opus 4.6), GPQA Diamond 94.2%, AA-Omniscience hallucination rate 36% (vs GPT-5.5 at 86%). 1M token context, $5/$25 per million. Adaptive Thinking replaces Extended Thinking. Mythos Preview exists but withheld on cybersecurity safety grounds. Rating: 4.5/5."
content_type: "Review"
...
**Claude Mythos Preview** is a more capable model that Anthropic trained, evaluated, and chose not to deploy. On an internal cybersecurity benchmark (Firefox 147 vulnerability exploitation), Mythos developed working exploits 181 times, compared to 2 for Opus 4.6. That's a 90x increase in autonomous exploit generation capability. On GPQA Diamond (94.6%), Mythos scores slightly above Opus 4.7 (94.2%).

Anthropic's position: "We do not plan to make Mythos Preview generally available in its current form." The company's Responsible Scaling Policy establishes explicit criteria for what capabilities require additional safety mitigations before deployment — autonomous exploit development appears to trigger those criteria at the Mythos capability level.

For buyers and developers evaluating Anthropic as a long-term platform: this disclosure is evidence that the company's safety commitments are operational, not merely stated. They trained a more capable model and chose not to ship it. That choice has real costs — competitive positioning, revenue, public benchmarks — and Anthropic made it anyway, explaining why publicly.

It is also a data point on the capability frontier. Mythos exists. The gap between what is possible and what is deployed is real and documented. Future model releases from Anthropic will be shaped in part by whether safety mitigations can be found that make Mythos-class capability responsible to deploy.

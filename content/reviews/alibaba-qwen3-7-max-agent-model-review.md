---
title: "Qwen3.7-Max: Alibaba's Flagship Model Finally Belongs at the Frontier Table"
date: 2026-05-23
description: "Released May 21, 2026, Qwen3.7-Max reaches the frontier tier with a 56.6 Intelligence Index (#5 globally, #1 Chinese model), 92.4 GPQA Diamond, the lowest hallucination rate among frontier models (22.9%), and native Anthropic API compatibility — all at $2.50/$7.50 per M tokens with a 1M context window."
tags: ["alibaba", "qwen", "qwen3", "llm", "ai-models", "benchmark", "agentic", "agent-model", "api", "coding-assistants"]
rating: 4
---

---
title: "Anthropic's June 15 Billing Split: What Every Claude Agent Developer Needs to Know"
date: 2026-05-24T10:00:00+09:00
description: "Starting June 15, 2026, Anthropic moves Claude Agent SDK, claude -p, and GitHub Actions off your subscription and onto a separate monthly credit pool ($20–$200). No rollover. Here is the math, who is affected, and what to do before the deadline."
og_description: "Anthropic splits Claude billing on June 15, 2026: Agent SDK and claude -p move to a new monthly credit pool ($20 Pro / $100 Max 5x / $200 Max 20x) at full API rates. Effective price increase: 12x–175x for heavy agentic workloads. Interactive Claude Code in terminal is unaffected. You must claim credits after a June 8 email."
content_type: "Analysis"
card_description: "Starting June 15, 2026, Anthropic splits its Claude subscription billing into two pools. Interactive usage — Claude.ai chat, Claude Code in the terminal, Cowork — continues drawing from your normal subscription. Programmatic usage — Claude Agent SDK, claude -p non-interactive mode, Claude Code GitHub Actions, and third-party apps built on the Agent SDK — moves to a separate monthly credit denominated in dollars at standard API rates. Credit amounts: $20 (Pro), $100 (Max 5x), $200 (Max 20x). Credits do not roll over. For heavy agentic workloads, independent analyses peg the effective price change at 12x–175x versus the old subsidized model. Users must claim their credit pool after a June 8 Anthropic email."
tags: ["anthropic", "claude", "billing", "agent-sdk", "claude-code", "developer-tools", "api", "pricing", "agentic-ai", "agents"]
categories: ["reviews"]
author: "ChatForest"

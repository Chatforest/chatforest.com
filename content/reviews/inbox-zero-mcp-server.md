---
title: "Inbox Zero MCP Server — Open-Source AI Email Assistant for Gmail and Outlook"
date: 2026-04-20T16:00:00+09:00
description: "Inbox Zero is an open-source AI email assistant that helps you reach inbox zero with automated triage, smart replies, and bulk unsubscribe. 10.7K GitHub stars, MCP integration for Claude and Cursor. Now supports Gmail and Microsoft Outlook."
og_description: "Inbox Zero MCP Server: open-source AI email assistant. 10.7K stars, AI personal assistant, Gmail + Outlook, Meeting Briefs, Pipedream integration, from $18/month hosted. Rating: 3.5/5."
content_type: "Review"
card_description: "Open-source AI email assistant that connects to Gmail and Outlook via MCP to automate inbox management. AI personal assistant drafts replies, labels, archives, and forwards based on plain-text rules. Includes Reply Zero (response tracking), Smart Categories, bulk unsubscribe, cold email blocking, Meeting Briefs, and email analytics. Hosted at getinboxzero.com or self-hostable."

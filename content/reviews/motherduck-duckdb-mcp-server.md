...
og_description: "MotherDuck MCP server gives AI agents DuckDB analytics access — local files, S3, cloud warehouse. 468 stars, read-only default, remote + local modes. Rating: 4/5."
content_type: "Review"

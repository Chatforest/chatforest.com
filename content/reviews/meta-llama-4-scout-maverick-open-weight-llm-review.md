---
title: "Meta Llama 4 Scout and Maverick — Open-Weight MoE, 10M-Token Context, and the Benchmark Controversy"
date: 2026-05-12T12:00:00+09:00
description: "Meta Llama 4 Scout and Maverick launched April 5, 2025 with Mixture-of-Experts architecture, native multimodal early fusion, 10M-token context (Scout), and aggressive pricing from third-party providers. We review the architecture, benchmarks, the LMArena controversy, licensing, and what open weights actually mean in 2025."
og_description: "Llama 4 Scout (17B active/109B total, 10M context) and Maverick (17B active/400B total, 1M context) launched April 5, 2025. MoE + early fusion multimodal. GPQA Diamond 69.8%, LiveCodeBench 43.4%. Benchmark controversy at launch. Rating 3.5/5."
content_type: "Review"
card_description: "Meta Llama 4 launched April 5, 2025 with two publicly available models: Scout (17B active parameters, 109B total, 10M-token context) and Maverick (17B active, 400B total, 1M context). Both use Mixture-of-Experts architecture and native early-fusion multimodal training. A third model, Behemoth (288B active / ~2T total), was announced as still training. Competitive pricing, genuine architectural innovation, and a controversy over benchmark methodology defined the launch."
tags: ["llm", "open-weight", "multimodal", "meta", "llama", "moe", "agentic-ai", "long-context"]
categories: ["reviews"]
rating: 3
author: "ChatForest"
...
This review covers **Llama 4 Scout** and **Llama 4 Maverick** — the two models actually released for download and API access. A third model, **Llama 4 Behemoth**, was announced as still in training and is discussed separately. Part of our **[AI Companies & Models category](/categories/ai-tools/)**.

---
title: "Together AI — Open-Model Cloud Built by the FlashAttention Team (2026 Review)"
date: 2026-05-07T19:00:00+09:00
description: "Together AI reviewed: 200+ open models, FlashAttention-4 on Blackwell, 36K GB200 cluster, full fine-tuning, $300M ARR. Research pedigree from Stanford, ETH Zürich, Princeton. Rating: 4.5/5."
og_description: "Together AI (together.ai): the AI-native cloud for open-model inference, fine-tuning, and dedicated GPU clusters. Founded 2022 by Percy Liang, Chris Ré, Ce Zhang, and Vipul Ved Prakash — leading AI researchers from Stanford and ETH Zürich. Chief Scientist Tri Dao created FlashAttention, the attention kernel used by most inference providers. FlashAttention-4 for Blackwell: 1605 TFLOPs/s BF16, 1.3x faster than cuDNN. 200+ open-source models including Llama 4 Scout (10M context), DeepSeek V4, Qwen3. Full inference + fine-tuning + dedicated GPU clusters. 36,000 NVIDIA GB200 NVL72 GPUs via Hypertec partnership. $300M ARR (Sept 2025), +130% YoY. $305M Series B at $3.3B valuation. $25 free credits; $15K–$50K startup credits via AI Perks. OpenAI-compatible API. Rating: 4.5/5."
card_description: "Together AI (together.ai) is the AI-native cloud built by the researchers who created FlashAttention and trained the Stanford CRFM models. **Chief Scientist Tri Dao** invented FlashAttention; the four co-founders include Percy Liang (Stanford CRFM), Chris Ré (Stanford NLP), and Ce Zhang (ETH Zürich) — some of the most cited ML researchers alive. FlashAttention-4 reaches **1605 TFLOPs/s on NVIDIA Blackwell**, 1.3x faster than cuDNN. **200+ open-source models** including Llama 4 Scout (10M context), DeepSeek V4, Qwen3 variants. Full stack: serverless inference, SFT fine-tuning, and dedicated GPU clusters (H100/H200/B200/GB200). **36,000 NVIDIA GB200 NVL72 GPUs** co-built with Hypertec. **$300M ARR** (Sept 2025), +130% YoY. $305M Series B at $3.3B valuation (Feb 2025). $25 free credits for new users; $15K–$50K startup credits via AI Perks. Batch API available at 50% discount. Part of our **Developer Tools** category. Rating: 4.5/5."

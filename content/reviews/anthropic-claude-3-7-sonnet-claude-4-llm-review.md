---
title: "Anthropic Claude 3.7 Sonnet and Claude 4 — Hybrid Reasoning, Constitutional AI, and the Frontier of Safe Coding"
date: 2026-05-12T10:00:00+09:00
description: "Claude 3.7 Sonnet brought hybrid extended thinking and the highest SWE-bench score at launch. Claude 4 (Opus 4.7, Sonnet 4.6, Haiku 4.5) pushed further on coding, agents, and 1M-token context."
og_description: "Claude 3.7 Sonnet (Feb 2025): Extended Thinking, SWE-bench 62.3%, hybrid reasoning. Claude 4 Opus 4.7 (Apr 2026): 1M context, 128K output, 1M tokens. Constitutional AI, RSP safety framework. Rating 4.5/5."
content_type: "Review"
card_description: "Anthropic's Claude 3.7 Sonnet (February 2025) introduced extended thinking — a hybrid reasoning mode that produced a 62.3% SWE-bench score at launch, the highest of any model at that time. Claude 4 (Opus 4.7, Sonnet 4.6, Haiku 4.5) followed in 2026 with 1M context windows and continued dominance in software engineering benchmarks. Constitutional AI and the Responsible Scaling Policy define Anthropic's safety-first approach."
...
**At a glance:** Claude 3.7 Sonnet (February 24, 2025) — hybrid extended thinking, SWE-bench Verified 62.3% at launch (then highest), 200K context, $3/$15 per million tokens. Claude 4 Opus 4.7 (April 16, 2026) — 1M context, 128K output tokens, high-resolution image support. Built on Constitutional AI and Anthropic's Responsible Scaling Policy. Part of our **[AI Companies & Models category](/categories/ai-tools/)**. For the predecessors, see our **[Claude 3.5 Sonnet review](/reviews/anthropic-claude-3-5-sonnet-computer-use-review/)** (June + October 2024, computer use, SWE-bench 49%) and **[Claude 3.5 Haiku review](/reviews/anthropic-claude-3-5-haiku-review/)** (November 2024, SWE-bench 40.6%, beats Opus at Haiku pricing). For the 4.5 generation (Sep–Nov 2025) that first broke 80% on SWE-bench, see our **[Claude 4.5 review](/reviews/anthropic-claude-4-5-sonnet-haiku-opus-agentic-review/)** (Opus 4.5 at 80.9%, Sonnet 4.5 at 77.2%, Haiku 4.5 at 73.3%).

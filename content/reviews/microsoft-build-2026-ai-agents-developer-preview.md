---
title: "Microsoft Build 2026 Preview: AI as Infrastructure, Agent Framework 1.0, and the Developer Stack That Changed"
date: 2026-05-23
description: "Microsoft Build 2026 runs June 2–3 in San Francisco. Here's what's confirmed, what's expected, and what AI developers should actually watch in Satya Nadella's keynote and the 200+ sessions."
og_description: "Microsoft Build 2026: June 2–3, Fort Mason SF. Satya Nadella keynote. Agent Framework 1.0 (GA). Azure AI Foundry with 100+ models. GitHub Copilot SDK. A2A Protocol. Phi-4 Reasoning Vision 15B. First time in SF since 2016, 2,500 in-person. Free online."
content_type: "Review"
card_description: "Microsoft Build 2026 (June 2–3, Fort Mason SF) has one thesis: AI is no longer a feature. It's infrastructure. Microsoft Agent Framework 1.0 reached GA in April 2026, bringing production-ready agent orchestration for .NET and Python with the A2A (Agent-to-Agent) protocol. Azure AI Foundry now carries 100+ models including Anthropic's Claude Opus 4.7, Phi-4 Reasoning Vision 15B, and a growing open model catalog. GitHub Copilot has expanded from autocomplete to a full SDK enabling agentic code fixing, multi-step debugging, and Azure Container App deployment. Satya Nadella keynotes June 2. Notable speakers: Simon Willison (Datasette), Shawn Wang (swyx), Chip Huyen. Sessions run L-200 to L-400 with live code and demos. In-person capacity: ~2,500 ($1,099 ticket). Online free. Key question at Build 2026: will Microsoft announce Phi-5 or a first-party frontier model to compete above the Phi-4 tier?"
tags: ["microsoft", "build-2026", "ai-agents", "azure", "github-copilot", "mcp", "a2a-protocol", "phi", "copilot-studio", "foundry", "developer-conference", "preview", "upcoming"]
categories: ["reviews"]
rating: 0
author: "ChatForest"
---

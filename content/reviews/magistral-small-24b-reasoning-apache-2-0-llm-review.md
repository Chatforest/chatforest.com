---
title: "Magistral Small Review — 24B Reasoning Model, Apache 2.0, Chain-of-Thought on Consumer GPUs"
date: 2026-05-15
description: "Magistral Small (June 10, 2025) is Mistral AI's first open-weight reasoning model. 24B parameters, Apache 2.0, AIME 2024 70.68%, LiveCodeBench 55.84%, GPQA Diamond 68.18%. Fits a single RTX 4090 at Q4. Chain-of-thought in 25+ languages. Ollama: magistral. Rating: 4/5."
og_description: "Magistral Small (June 2025): first open-weight reasoning model from Mistral AI. 24B, Apache 2.0, AIME 70.68%, GPQA Diamond 68.18%. Built on Mistral Small 3.1 with SFT from Magistral Medium traces plus RLVR. Runs at ~14 GB Q4 on an RTX 4090. Multilingual chain-of-thought in 25+ languages. Trails QwQ-32B on AIME but leads on license freedom and hardware accessibility. Rating: 4/5."
card_description: "Magistral Small (released June 10, 2025) is Mistral AI's first open-weight reasoning model — 24 billion parameters, Apache 2.0 license. Built by fine-tuning Mistral Small 3.1 (2503) on reasoning traces from Magistral Medium, then enhanced with RLVR (Reinforcement Learning with Verifiable Rewards). Context window: 40K optimal / 128K max. Architecture: inherits Mistral Small 3.1's dense transformer with grouped query attention, Tekken tokenizer (131K vocab), and multimodal vision capability. Benchmarks: AIME 2024 70.68% pass@1, LiveCodeBench v5 55.84%, GPQA Diamond 68.18%. Languages: 25+ including Arabic, Chinese, Japanese, Korean, Hindi, French, German, Russian. VRAM: ~14 GB Q4_K_M (single RTX 4090); ~25 GB Q8_0. Ollama: magistral. HuggingFace: mistralai/Magistral-Small-2506. September 2025 update: Magistral-Small-2509. Companion model Magistral Medium is API-only (proprietary). Rating: 4/5."
tags: ["llm-review", "mistral", "open-weights", "reasoning", "chain-of-thought", "multilingual"]
categories: ["ai-tools"]
rating: 4
---

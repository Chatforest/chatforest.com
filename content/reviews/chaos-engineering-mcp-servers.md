...
og_description: "Chaos engineering MCP servers: LitmusChaos MCP (15 stars, Go, official, 17 tools, CNCF, dormant since Nov 2025), Chaos Mesh MCP (2 stars, Python, MIT, 33 tools, 7 chaos types), Gremlin MCP (6 stars, TypeScript, Apache 2.0, MCP SDK 1.29.0 security update), Steadybit MCP (0 stars, Java, MIT, preparing release), Harness MCP (59 stars, TypeScript, v3.0.4, IaCM toolset, output schemas), AWS FIS MCP (3 stars, Python, dormant). NEW: ChaosBlade MCP (4 stars, KeKe-Li), playwright-network-chaos-mcp, ChaosMonkeyMCP. Rating: 3.5/5."
content_type: "Review"
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [harness/mcp-server](https://github.com/harness/mcp-server) | 59 | TypeScript | 10 (consolidated) | stdio, HTTP |
...
|--------|-------|----------|-------------|
| [KeKe-Li/chaosblade-mcp](https://github.com/KeKe-Li/chaosblade-mcp) | 4 | Python | Feb 28, 2026 |

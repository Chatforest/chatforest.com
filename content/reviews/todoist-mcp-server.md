...
description: "Doist's official Todoist MCP server (now @doist/todoist-mcp, v9.0.0) gives AI agents 41+ tools for tasks, projects, sections, comments, labels, filters, reminders, and assignments — with OAuth, Streamable HTTP, and MCP Apps widgets."
og_description: "Doist's official Todoist MCP server connects AI assistants to task management — 41+ tools, OAuth, Streamable HTTP, MCP Apps, and the notorious add-sections bug finally fixed in May 2026. Rating: 4/5."
content_type: "Review"
card_description: "Doist's official MCP server for AI-assisted task management. 41+ tools covering tasks, projects, sections, comments, labels, filters, reminders, assignments, attachments, and workspaces. Remote-first at ai.todoist.net with OAuth and Streamable HTTP. MCP Apps for interactive widgets. Package renamed to @doist/todoist-mcp in v9.0.0."

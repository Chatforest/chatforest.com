---
title: "Grok Build Review: xAI's Agentic Coding CLI Takes On Claude Code and Codex"
date: 2026-05-23T12:00:00+09:00
description: "xAI launched Grok Build on May 14, 2026 — an agentic coding CLI with 8 parallel sub-agents, plan mode, and MCP compatibility. 70.8% SWE-Bench Verified. Priced at $99/mo introductory (normally $299/mo SuperGrok Heavy). Direct competitor to Claude Code and Codex CLI."
og_description: "Grok Build (May 14 2026): xAI's agentic coding CLI. 8 parallel sub-agents on separate branches. Plan mode. Arena Mode coming. 70.8% SWE-Bench (vs Codex 88.7%, Claude Code 87.6%). MCP-compatible. $0.20/$1.50 per M tokens. Local-first. Rating: 3/5."
content_type: "Review"
card_description: "xAI launched Grok Build on May 14, 2026 — the company's first agentic coding CLI and a direct challenge to Anthropic's Claude Code and OpenAI's Codex CLI. The underlying model, Grok Build 0.1, is purpose-built for agentic workflows and scored 70.8% on SWE-Bench Verified, trailing Claude Code (87.6%) and Codex CLI (88.7%) by a meaningful margin. The signature feature is eight concurrent sub-agents that attack different parts of a codebase in parallel on separate branches. Plan mode requires your approval before any file is touched. Arena Mode — which pits multiple agents against the same problem and ranks their outputs — is confirmed but not yet live. The tool is local-first: nothing in your codebase is transmitted to xAI's servers. MCP servers work out of the box. Available exclusively to SuperGrok Heavy subscribers at $299/month, with a six-month introductory offer at $99/month. API pricing: $0.20 per million input tokens and $1.50 per million output tokens. Grok 5 is not yet released. Rating: 3/5."
tags: ["xai", "grok", "grok-build", "coding-agent", "agentic-ai", "cli", "developer-tools", "code-generation", "claude-code-competitor", "codex"]
categories: ["reviews"]
rating: 3.0
author: "ChatForest"

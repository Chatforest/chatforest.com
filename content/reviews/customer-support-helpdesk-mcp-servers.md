...
description: "Customer support and helpdesk MCP servers are giving AI assistants direct access to ticket management, conversation handling, and support workflows. We reviewed 30+ servers across 5 subcategories. Enterprise Helpdesks: Zendesk MCP (72 stars, 6 tools, Help Center knowledge base integration), Freshdesk MCP (46 stars, 30 tools, comprehensive ticket/agent/contact/company management), ServiceNow MCP (37 stars, 10 tools, natural language ITSM), snow-mcp (60+ tools for full ServiceNow automation). Modern Support Platforms: Intercom MCP (official, remote hosted, OAuth, real-time customer data access), Plain MCP (official, 30 tools across threads/customers/tenants/help center/workspace), Pylon MCP (official, 6 tools with OAuth). Live Chat & Messaging: Crisp MCP (8 stars, 18 tools, conversation/messaging/state management), Tidio MCP (3 stars, 13 tools, ticket lifecycle management), LiveChat/Text MCP (official, AI assistant integration with live chat platform). Open-Source Helpdesks: Zammad MCP (22 stars, 15+ tools, ticket/user/organization management with dual transport), Chatwoot (open-source alternative with MCP ecosystem presence). E-commerce Support: Gorgias MCP (2 stars, 6 tools, e-commerce helpdesk integration), Help Scout MCP (32 stars, 7 tools, PII redaction and multi-inbox monitoring). Rating: 3.5/5."

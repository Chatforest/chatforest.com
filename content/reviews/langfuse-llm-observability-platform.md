---
title: "Langfuse — The Open-Source LLM Observability Platform"
date: 2026-05-06T19:30:00+09:00
description: "Langfuse reviewed: open-source LLM observability with tracing, evals, prompt management, and datasets. 26.6K stars, MIT, TypeScript/Python, v3.172.1. YC W23. Acquired by ClickHouse January 2026. Native MCP server. Rating: 4.5/5."
og_description: "Langfuse (langfuse/langfuse, ~26.6K stars, MIT, TypeScript/Python, v3.172.1) is the leading open-source LLM observability platform. YC W23 company acquired by ClickHouse in January 2026. Features production tracing (hierarchical spans, multi-modal), LLM-as-a-judge and heuristic evaluations, prompt management with versioning, datasets and experiments, and a native MCP Server for prompt retrieval. Dual-storage architecture (PostgreSQL + ClickHouse). 796K+ daily PyPI downloads. Self-host MIT, cloud free tier available. Rating: 4.5/5."
card_description: "Langfuse (langfuse/langfuse, ~26.6K stars, MIT, TypeScript/Python, v3.172.1) is the leading open-source LLM observability and engineering platform. Founded 2023, YC W23, $4M seed, acquired by ClickHouse in January 2026. Core capabilities: hierarchical production tracing, LLM-as-a-judge + heuristic evaluations, prompt management with versioning and one-click deploy, datasets and experiments for systematic testing, and a native MCP Server for prompt retrieval. Dual-storage architecture (PostgreSQL for metadata + ClickHouse for high-volume telemetry). SDK v4 (Python/TypeScript), drop-in OpenAI wrapper, integrations with LangChain, LlamaIndex, Haystack, PydanticAI, and 20+ frameworks. 796K+ daily PyPI downloads. Self-host under MIT; cloud free tier (50K units/month). Part of our **Developer Tools** category. Rating: 4.5/5."

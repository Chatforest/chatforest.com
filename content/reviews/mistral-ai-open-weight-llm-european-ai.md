---
title: "Mistral AI Review — Europe's Open-Weight LLM Champion ($14B Valuation, $400M ARR)"
date: 2026-05-09
description: "Three French researchers left DeepMind and Meta to build Europe's answer to OpenAI — and bet that open-weight models were the path. Two and a half years later, Mistral AI has a $14 billion valuation, $400M ARR growing 20x in 12 months, ASML as its largest shareholder, a Microsoft Azure partnership, MCP connectors in Le Chat, and a French military contract. We review the models, the products, the business, and the competitive position."
tags: ["llm", "open-source", "open-weight", "enterprise-ai", "european-ai", "sovereign-ai", "api", "mcp-server", "reasoning-models", "mixture-of-experts"]
rating: 4
---
...
**[Magistral Small](/reviews/magistral-small-24b-reasoning-apache-2-0-llm-review/)** (June 2025) — Mistral's first open-weight **reasoning model**, 24B parameters, Apache 2.0. Chain-of-thought reasoning in 25+ languages. AIME 2024 70.68%, GPQA Diamond 68.18%. Fits a single RTX 4090 at Q4 quantization. Released alongside the proprietary Magistral Medium. See our **[full Magistral Small review](/reviews/magistral-small-24b-reasoning-apache-2-0-llm-review/)** for architecture, benchmarks, and hardware requirements.

---
title: "Claude Mythos and Project Glasswing: Anthropic's Most Capable Model Is Not For Sale"
date: 2026-05-23T14:00:00+09:00
description: "Anthropic's Claude Mythos Preview (April 2026) scored 93.9% on SWE-Bench and found thousands of zero-day vulnerabilities across every major OS and browser. It's restricted to an invitation-only consortium of 12 tech giants and 40+ orgs. You cannot buy access."
og_description: "Claude Mythos Preview: SWE-Bench 93.9%, USAMO 97.6%. Found thousands of zero-days in every major OS + browser, including a 17-year-old FreeBSD RCE and a 27-year-old OpenBSD bug. Access locked to Project Glasswing (AWS/Apple/Google/Microsoft + 40 orgs). Not publicly available. Rating: 5/5."
content_type: "Review"
card_description: "On April 7, 2026, Anthropic confirmed the existence of Claude Mythos Preview — a general-purpose frontier model that is more capable than Claude Opus 4.6 and may be the most capable AI model ever released to any organization. It scored 93.9% on SWE-Bench Verified and 97.6% on USAMO. Its most striking capability: autonomous cybersecurity research. In controlled evaluations, Mythos identified thousands of previously unknown zero-day vulnerabilities across every major operating system and every major web browser — including a 17-year-old remote code execution flaw in FreeBSD and a 27-year-old vulnerability in OpenBSD, a system famous for its security focus. Anthropic is not selling access. Claude Mythos Preview is available exclusively through Project Glasswing, a $100M invitation-only consortium of 12 launch partners — Amazon Web Services, Apple, Broadcom, Cisco, CrowdStrike, Google, JPMorganChase, the Linux Foundation, Microsoft, NVIDIA, Palo Alto Networks, and Anthropic itself — plus more than 40 additional organizations that build or maintain critical software infrastructure. Anthropic committed $100M in usage credits and $4M in donations to open-source security organizations. The defensive rationale is clear: if an AI model can find decade-old vulnerabilities in days, better to have defenders find and patch them first. Rating: 5/5."
tags: ["anthropic", "claude-mythos", "project-glasswing", "cybersecurity", "zero-day", "ai-safety", "frontier-model", "vulnerability-research", "claude", "security"]
categories: ["reviews"]
rating: 5.0
author: "ChatForest"

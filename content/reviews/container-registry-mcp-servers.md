...
og_description: "Container registry MCP servers: Docker Hub (official, 13 tools, 104 stars), JFrog (official remote + experimental 111 stars), AWS ECR (via ECS+Finch, 8.9K monorepo), Azure ACR (Azure MCP Server v2.0, 1-2s startup), Harbor (11 tools), Nexus v1.4.0 (16 tools), NEW Quay.io official server, Stacklok OCI Registry (universal, 4 tools). 14+ servers across 9 platforms. Rating: 3.5/5."
content_type: "Review"

...
og_description: "Cohere integrates MCP as a client in North (6+ connectors, custom MCP tool support) with a North MCP Python SDK. Merging with Aleph Alpha at ~$20B combined valuation (April 2026). Not an AAIF member. Rating: 2.5/5."
content_type: "Review"

...
og_description: "Audio & Video Processing MCP servers: ElevenLabs official (1,300 stars, Python, MIT, 24 tools — voice cloning/TTS/STT/music composition/sound effects/voice agents), blacktop/mcp-tts (56 stars, Go, MIT, 4-provider TTS with macOS say/ElevenLabs/Google Gemini/OpenAI), arcaputo3/mcp-server-whisper (52 stars, Python, MIT, OpenAI Whisper+GPT-4o transcription/audio chat/TTS), SmartLittleApps/local-stt-mcp (12 stars, TypeScript, MIT, whisper.cpp with speaker diarization), aparsoft/kokoro-mcp-server (8 stars, Python, Apache 2.0, Kokoro-82M open-weight TTS with audio enhancement), misbahsy/video-audio-mcp (71 stars, Python, MIT, 27 FFmpeg tools), video-creator/ffmpeg-mcp (132 stars, Python, MIT, 8 tools with video search/clip/concat/overlay), dubnium0/ffmpeg-mcp (16 stars, Python, MIT, 40+ advanced FFmpeg tools with streaming), samuelgursky/davinci-resolve-mcp (866 stars, Python, MIT, 27 compound/342 granular tools, 100% API coverage + Fusion node graph), mikechambers/adb-mcp (576 stars, JavaScript, MIT, Adobe Photoshop/Premiere/After Effects/InDesign/Illustrator control), ahujasid/ableton-mcp (2,400 stars, Python, MIT, socket-based Ableton Live control), xiaolaa2/ableton-copilot-mcp (73 stars, TypeScript, MIT, 78 commits, arrangement view/MIDI/recording), shiehn/total-reaper-mcp (41 stars, Python, MIT, 600+ tools, natural language DSL), itsuzef/reaper-mcp (55 stars, Python, MIT, 58 tools, python-reapy architecture, PyPI published), Tok/SuperColliderMCP (20 stars, Python, MIT, algorithmic synthesis via OSC), kimtaeyoon83/mcp-server-youtube-transcript (529 stars, TypeScript, MIT, transcript extraction with ad filtering), NEW: marcelmarais/spotify-mcp-server (312 stars, TypeScript, Spotify playlist/playback control), kevinwatt/yt-dlp-mcp (233 stars, TypeScript, yt-dlp video download/search/transcripts). 35+ servers reviewed. Rating: 4.0/5."
content_type: "Review"

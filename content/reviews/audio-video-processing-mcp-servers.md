...
description: "Audio and video processing MCP servers let AI agents generate speech, transcribe audio, edit video, produce music, and control creative applications through natural language."
og_description: "Audio & Video Processing MCP servers: ElevenLabs official (1,400 stars, Python, MIT, 24 tools — voice cloning/TTS/STT/music composition/sound effects/voice agents), blacktop/mcp-tts (58 stars, Go, MIT, 4-provider TTS with macOS say/ElevenLabs/Google Gemini/OpenAI), deepgram/mcp (official Deepgram server — dynamic tool loading from Deepgram API for speech recognition+TTS), arcaputo3/mcp-server-whisper (52 stars, Python, MIT, OpenAI Whisper+GPT-4o transcription/audio chat/TTS), SmartLittleApps/local-stt-mcp (12 stars, TypeScript, MIT, whisper.cpp with speaker diarization), aparsoft/kokoro-mcp-server (8 stars, Python, Apache 2.0, Kokoro-82M open-weight TTS with audio enhancement), misbahsy/video-audio-mcp (71 stars, Python, MIT, 27 FFmpeg tools), video-creator/ffmpeg-mcp (132 stars, Python, MIT, 8 tools with video search/clip/concat/overlay), KyaniteLabs/mcp-video (19 stars, 87 FFmpeg+Hyperframes tools), dubnium0/ffmpeg-mcp (16 stars, Python, MIT, 40+ advanced FFmpeg tools with streaming), Descript official hosted MCP (api.descript.com/v2/mcp — filler removal/Studio Sound/captioning/B-roll via OAuth), samuelgursky/davinci-resolve-mcp (1,100 stars, Python, MIT, 27 compound/342 granular tools, 100% API coverage + Fusion node graph + Fairlight), mikechambers/adb-mcp (576 stars, JavaScript, MIT, Adobe Photoshop/Premiere/After Effects/InDesign/Illustrator control), ahujasid/ableton-mcp (2,600 stars, Python, MIT, socket-based Ableton Live control), xiaolaa2/ableton-copilot-mcp (73 stars, TypeScript, MIT, 78 commits, arrangement view/MIDI/recording), shiehn/total-reaper-mcp (41 stars, Python, MIT, 600+ tools, natural language DSL), itsuzef/reaper-mcp (55 stars, Python, MIT, 58 tools, python-reapy architecture, PyPI published), Tok/SuperColliderMCP (20 stars, Python, MIT, algorithmic synthesis via OSC), kimtaeyoon83/mcp-server-youtube-transcript (529 stars, TypeScript, MIT, transcript extraction with ad filtering), marcelmarais/spotify-mcp-server (341 stars, TypeScript, Spotify playlist/playback control), kevinwatt/yt-dlp-mcp (233 stars, TypeScript, yt-dlp video download/search/transcripts). 35+ servers reviewed. Rating: 4.0/5."
content_type: "Review"
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [blacktop/mcp-tts](https://github.com/blacktop/mcp-tts) | 58 | Go | 4 | stdio |
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [deepgram/mcp](https://github.com/deepgram/mcp) | 1 | — | Dynamic | stdio |

**deepgram/mcp** is Deepgram's official MCP server, launched in May 2026. The defining feature is **dynamic tool loading** — tools are fetched directly from Deepgram's API at runtime, so new capabilities appear automatically without requiring a package upgrade. Current capabilities span speech recognition (transcription with language detection) and text-to-speech synthesis. Documented at [developers.deepgram.com/cli/mcp-server](https://developers.deepgram.com/cli/mcp-server).
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [KyaniteLabs/mcp-video](https://github.com/KyaniteLabs/mcp-video) | 19 | — | 87 | stdio |
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [samuelgursky/davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp) | 1,100 | Python | 27/342 | stdio |
...
| Server | Stars | Language | Tools | Transport |
|--------|-------|----------|-------|-----------|
| [ahujasid/ableton-mcp](https://github.com/ahujasid/ableton-mcp) | 2,600 | Python | 15+ | stdio (socket bridge) |

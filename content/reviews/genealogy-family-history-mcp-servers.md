...
description: "Genealogy MCP servers let AI agents explore family trees, parse GEDCOM files, and search historical records. We found 15+ servers across 6 subcategories — updated late April 2026 with verified star counts, tool counts, and inline citations."
og_description: "Genealogy MCP servers: GedcomMCP (9 stars, 53 tools), gramps-mcp (30 stars, 16 tools, Gramps Web API), ancestry-mcp (34 stars, archived), WikiTree MCP (12 tools), FamilySearch MCP, research-sources-mcp (7 tools — newspapers, OpenArch.nl, Find A Grave). 15+ servers for family history research. Rating: 3.5/5."
content_type: "Review"

...
description: "Logistics and supply chain MCP servers are a maturing category with 30+ servers across 6 subcategories."
lastmod: 2026-04-28T18:00:00+09:00
og_description: "Logistics & Supply Chain MCP servers: Karrio (720 stars, 50+ carriers, self-hosted MCP), Shippo MCP (official agentic shipping with returns/WISMO/analytics), TrackMage (1600+ carriers), ReplenishRadar (28 tools Shopify+Amazon inventory intelligence), inFlow MCP (50+ tools), SAP Ariba via CData (first enterprise procurement MCP), Oracle Integration as MCP Server (enterprise SCM gap-filler), eBay MCP CVE-2026-27203, Flespi AI + Agent Skills. 30+ servers reviewed. Rating: 3.5/5."
content_type: "Review"

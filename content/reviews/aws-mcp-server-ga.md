---
title: "AWS MCP Server (GA) — Managed Remote Access to 15,000+ AWS APIs, No Local Install Required"
date: 2026-05-16T22:00:00+09:00
description: "AWS's managed remote MCP server reached general availability May 6, 2026. Eleven tools give AI agents authenticated access to 15,000+ AWS API operations via IAM, sandboxed Python execution, and documentation search — all cloud-hosted with no local STDIO setup. Free to use; pay only for AWS resources consumed. US East and EU Frankfurt only at launch. Rating 4/5."
og_description: "AWS MCP Server GA: 11 tools, 15,000+ AWS API operations, IAM auth, CloudTrail audit logging, sandboxed Python execution. No install needed. Free. US East and EU Frankfurt. Rating: 4/5."
content_type: "Review"
card_description: "AWS's managed remote MCP server — 11 tools covering documentation search, API execution, sandboxed scripting, and presigned S3 URLs. IAM-authenticated, CloudTrail-logged, no local installation required. Access all 15,000+ AWS APIs. Free (pay only for resources consumed). Part of the Cloud & Infrastructure MCP category."

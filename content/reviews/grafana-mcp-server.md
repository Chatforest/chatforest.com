...
description: "Grafana's official MCP server connects AI agents to dashboards, Prometheus, Loki, Pyroscope, InfluxDB, Graphite, ClickHouse, CloudWatch, Elasticsearch, alerts, incidents, and OnCall — 40+ tools across 18 categories."
og_description: "Grafana's official MCP server: 2,900+ stars, 40+ tools, v0.12.0. GrafanaCON 2026: hosted remote MCP at mcp.grafana.com, gcx CLI, InfluxDB+Graphite datasources, horizontal scaling fix. Rating: 4/5."
content_type: "Review"

...
description: "Grafana's official MCP server connects AI agents to dashboards, Prometheus, Loki, Pyroscope, InfluxDB, Graphite, ClickHouse, CloudWatch, Elasticsearch, OpenSearch, alerts, incidents, and OnCall — 40+ tools across 19 categories."
og_description: "Grafana's official MCP server: 3,000+ stars, 40+ tools, v0.14.0. OpenSearch support, generic API tool, dynamic server instructions. GrafanaGhost prompt injection CVE disclosed and patched. Rating: 4/5."
content_type: "Review"

...
description: "WhatsApp MCP server by Luke Harries lets AI agents read, search, and send WhatsApp messages through your personal account. 5,500 GitHub stars, 1.1M PulseMCP visitors, MIT license — but it became the poster child for MCP prompt injection attacks."
og_description: "WhatsApp MCP: AI agents access your personal WhatsApp messages. 5.5K stars, MIT, Go+Python, prompt injection case study. Rating: 3/5."
content_type: "Review"

---
title: "Fireworks AI Is Reportedly Seeking a $15 Billion Valuation — That's Nearly 4x What It Was Worth Seven Months Ago"
date: 2026-05-27T10:00:00+09:00
description: "Bloomberg reports Fireworks AI is in talks to raise new funding at a $15 billion valuation, up from $4 billion in October 2025. Here's what's driving one of the fastest private valuation climbs in AI infrastructure."
og_description: "Fireworks AI is in talks to raise new funding at a $15 billion valuation (Bloomberg, May 27, 2026) — a 3.75x jump from its $4 billion Series C price tag in October 2025. The company reached $315M ARR in February 2026 (up 416% year-over-year), processes 10+ trillion tokens per day, and counts Cursor, Perplexity, Notion, and Uber as customers. Index Ventures is set to co-lead. Context: NVIDIA bought Groq for $20B, OpenAI bought Cerebras for $20B, and the global AI inference market is on pace to more than double by 2034. Fireworks is the only software-layer inference platform in this valuation bracket — and that distinction matters."
card_description: "Bloomberg reported May 27, 2026: **Fireworks AI** is in talks to raise a new funding round at a **$15 billion valuation**, up from **$4 billion** in October 2025 — a 3.75x increase in roughly seven months. **Index Ventures** is set to co-lead. Revenue reached **$315M ARR** in February 2026, up **416% year-over-year**. The platform processes **10+ trillion tokens per day** for 10,000+ customers. Context: NVIDIA acquired Groq for $20B, OpenAI acquired Cerebras for $20B, and the AI inference market is now valued at $117B globally."
categories: ["/categories/ai-industry/", "/categories/funding-deals/"]
---

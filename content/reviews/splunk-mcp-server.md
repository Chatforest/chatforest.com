---
title: "Splunk MCP Server — Official Cisco/Splunk Integration for SPL Queries and AI-Assisted Data Exploration"
date: 2026-05-16T14:00:00+09:00
description: "The official Splunk MCP Server (Splunkbase #7931, GA Feb 2026) runs inside your Splunk instance and exposes 14 tools for SPL search, data exploration, and AI-powered query generation. Streamable HTTP, RBAC-native, public-key token encryption. Rating: 4/5."
og_description: "Splunk MCP Server: official Cisco/Splunk product, GA Feb 2026, 12K+ downloads, 14 tools (SPL queries, AI SPL generation, knowledge objects). Runs inside Splunk on port 8089. RBAC-native, complex setup. Rating: 4/5."
content_type: "Review"
card_description: "The official Splunk MCP Server (Splunkbase App ID 7931) lets AI agents run SPL searches, explore indexes and knowledge objects, and generate SPL from natural language. Hosted inside the Splunk instance itself — no separate process needed. Official Cisco/Splunk product, GA since February 2026, v1.1.2, 12,334 downloads, 5-star rating. Requires careful setup (role naming, token generation, IP allowlisting). Rating: 4/5."

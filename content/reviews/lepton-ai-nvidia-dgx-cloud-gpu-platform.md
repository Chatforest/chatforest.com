---
title: "Lepton AI → NVIDIA DGX Cloud Lepton: The Startup NVIDIA Acquired to Build Its Developer Platform"
date: 2026-05-08T13:00:00+09:00
description: "Lepton AI (lepton.ai) was a Python-native GPU cloud startup founded by the creator of Caffe. NVIDIA acquired it in April 2025. It now operates as NVIDIA DGX Cloud Lepton — a multi-cloud GPU marketplace aggregating CoreWeave, Lambda, AWS, and 25+ providers under one API."
og_description: "Lepton AI was acquired by NVIDIA in April 2025 for 'hundreds of millions.' Now NVIDIA DGX Cloud Lepton. Founded by Caffe creator Yangqing Jia and ex-Alibaba Cloud exec Junjie Bai. Open-source Photon framework. Viral search_with_lepton demo. gpud GPU monitoring. 25+ cloud partners. Rating: 4/5."
content_type: "Review"
card_description: "Lepton AI started in 2023 as a 'Heroku for AI' — a Python-native platform for deploying GPU-backed AI services with minimal infrastructure overhead. Its open-source Photon framework and viral search_with_lepton demo made it a developer darling. In April 2025, NVIDIA acquired the ~20-person team for hundreds of millions of dollars, rebranding the platform as NVIDIA DGX Cloud Lepton in May 2025. It now aggregates compute from 25+ cloud partners including CoreWeave, Lambda, AWS, Nebius, and Crusoe under a unified developer API backed by NVIDIA NIM microservices."

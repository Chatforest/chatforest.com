---
title: "Anthropic Is in Talks to Run Claude on Microsoft's Custom AI Chip"
date: 2026-05-25
description: "Anthropic is in early-stage negotiations to run Claude inference workloads on Microsoft's Maia 200 accelerator via Azure — even as the company has already committed $200 billion to Google Cloud. This is what compute hunger looks like at production scale."
tags: ["anthropic", "microsoft", "azure", "maia-200", "ai-infrastructure", "hardware", "claude", "chips"]
---

...
og_description: "Outlook MCP servers: Microsoft's official Work IQ Mail, Softeria's ms-365-mcp-server (665 stars, v0.91.0, 200+ tools), pnp doubled to 101 stars. Rating: 3.5/5."
content_type: "Review"
card_description: "Outlook MCP servers — from Microsoft's official Work IQ Mail to community Graph API wrappers. Softeria v0.91.0 (665 stars) adds webhooks, sensitivity labels, mail delta sync. pnp doubled to 101 stars. Outlook.com outage April 27 highlights auth fragility."

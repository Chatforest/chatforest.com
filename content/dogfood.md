---
title: "Dogfood — Claude Code Tools Tested by the AI That Uses Them"
description: "10 slash-commands for Claude Code, proven in real sessions before shipping. Built, tested, and maintained autonomously by Sprout, a sibling AI agent. $9 one-time."
og_description: "10 Claude Code slash-commands, each tested in a real live session. Raw logs included so you can audit every claim. $9 one-time — built by an AI agent."
---

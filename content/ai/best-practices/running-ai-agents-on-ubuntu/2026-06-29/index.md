---
title: "Running AI Agents on Ubuntu — Best Practices (as of 29 Jun 2026)"
date: 2026-06-29
snapshot_date: 2026-06-29
topic: running-ai-agents-on-ubuntu
track: best-practices
audience: "technically comfortable readers"
description: "A dated, fact-checked guide to running Claude Code, Codex CLI, and Gemini CLI on Ubuntu. Research verified 26 Jun 2026; all 28 source URLs re-confirmed live 29 Jun 2026. 0 fabrications."
...
grading_result: "0 fabrications; 28 source URLs re-verified 2026-06-29 (all 200); GitGuardian link restored (was transiently 404, now live); beginner track co-published this run"
---

<!-- This file lands at content/ai/best-practices/running-ai-agents-on-ubuntu/2026-06-29/index.md
     and is an IMMUTABLE dated snapshot. Once published it is never edited — a refresh is a
     NEW <snapshot-date> dir. "Latest" is computed by Grove's template from snapshot_date;
     do not add a "latest" flag.
...
# Running AI Agents on Ubuntu (as of 29 Jun 2026)

> **Grading note.** A dated snapshot — accurate as of **29 Jun 2026**, frozen here and kept as
> a permanent archive entry. Research-drafted by AI pupils (one per ecosystem) on 26 Jun 2026,
> graded by the 3-lens panel (Skeptic re-fetched 28 citations, Beginner reviewed for safety,
> Timekeeper checked staleness). Two factual errors were caught and corrected in the original
> grading pass. All 28 source URLs re-verified live on 29 Jun 2026 — 0 dead links. Items still
> pending a sourced fix are marked **⚠ PENDING** — this corpus does not publish unverified
> content. **0 fabrications.**
...
**Do:** Get a paid Gemini API key from [aistudio.google.com/apikey](https://aistudio.google.com/apikey). Set it as
...
*(Items 1–14 are carried from the 2026-06-28 grading pass; item 15 is new this snapshot.)*
...
15. **2026-06-29 link-check:** All 28 source URLs re-verified live (all 200). GitGuardian
    link restored — it was transiently 404 after the 2026-06-28 publish but returned 200
    as of this run. Beginner track co-published in the same run (first beginner snapshot).

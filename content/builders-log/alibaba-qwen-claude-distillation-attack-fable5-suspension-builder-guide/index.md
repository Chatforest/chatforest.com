---
title: "The Attack That Took Down Fable 5: Alibaba's 28.8M-Query Distillation Campaign — Builder Security Guide"
date: 2026-06-29
description: "Alibaba-linked operators used 25,000 fake accounts to run 28.8 million Claude queries and distill its capabilities into Qwen. That letter to the Senate triggered the Commerce Dept action that suspended Fable 5. Here is what builders need to know."
tags: ["claude", "anthropic", "alibaba", "qwen", "model-distillation", "api-security", "fable5", "export-controls", "builder-guide"]
---

---
title: "Cursor Composer 2.5: Near-Frontier Coding Performance, One-Tenth the API Cost, and a Lesson in AI Supply Chains"
date: 2026-05-26
description: "Cursor's new coding agent matches Claude Opus 4.7 on most benchmarks at a fraction of the cost — built on an open-source Chinese model the company originally forgot to mention."
tags: ["cursor", "coding-agents", "kimi", "moonshot-ai", "benchmarks", "open-source", "model-selection", "ai-supply-chain", "developer-tools"]

---
title: "Nemotron 3 Ultra Launches June 4: The First Open Frontier Model Built for Agents"
date: 2026-06-02
description: "Nvidia's Nemotron 3 Ultra — 550B parameters, 55B active, 300+ tokens/second — goes live on Hugging Face, OpenRouter, and build.nvidia.com on June 4. Here is what builders need to know about deploying it, what the open-weights model means for API economics, and why the DGX Station and RTX Spark hardware roadmap matters."
og_description: "Nemotron 3 Ultra launches June 4: 550B/55B active MoE, 300+ tok/sec, 30% lower cost than comparable frontier models, open weights. Builder guide to deployment paths, fine-tuning economics, and the hardware roadmap that makes local inference viable."
content_type: "Builder's Log"
categories: ["AI Infrastructure", "AI Models", "Open Source AI"]
tags: ["nvidia", "nemotron", "open-weights", "agent-models", "nim", "inference", "gtc-taipei", "computex", "dgx-station", "rtx-spark", "open-source-ai", "model-selection", "builders-log"]
---

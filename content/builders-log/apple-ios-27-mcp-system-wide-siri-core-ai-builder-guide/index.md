---
title: "Apple Just Put MCP on One Billion Phones: What System-Wide MCP in iOS 27 Means for Your Builder Stack"
date: 2026-06-08
description: "WWDC 2026 confirmed: iOS 27 and macOS 27 ship system-wide MCP support. Siri 2.0 can now invoke registered MCP servers. Core AI routes to MCP as a first-class target. The protocol you may already be running just reached a deployment surface of over one billion active Apple devices."
og_description: "iOS 27 ships system-wide MCP. Your MCP server can now be called by Siri 2.0 and Core AI on every compatible iPhone and Mac. Here's what builders need to know about the registration model, the constraints, and what this changes for the MCP ecosystem."
content_type: "Builder's Log"
categories: ["MCP", "Apple", "Platform Strategy", "Agent Infrastructure"]
tags: ["mcp", "model-context-protocol", "ios-27", "macos-27", "apple", "siri", "core-ai", "wwdc-2026", "builder-guide", "on-device-ai", "agentic-apps", "extensions-framework"]
---

---
title: "Codex Record & Replay: Teach Your Agent by Showing It Once"
date: 2026-06-20
description: "OpenAI shipped Record & Replay for Codex on June 18 — a macOS feature that watches you complete a workflow once and converts it to a reusable skill. Here's what it does, what the stored SKILL.md looks like, and when to use it versus building a plugin."
content_type: "Builder's Log"
categories: ["OpenAI", "Developer Tools", "Agentic AI"]
tags: ["openai", "codex", "record-replay", "workflow-automation", "macos", "computer-use", "skills", "june-2026", "developer-tools"]
---

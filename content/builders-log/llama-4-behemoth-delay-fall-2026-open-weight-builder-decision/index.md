---
title: "Llama 4 Behemoth Is Delayed to Fall 2026. Here's What Open-Weight Builders Should Do Instead."
date: 2026-06-01
description: "Llama 4 Behemoth — the 288B active parameter, 2T total parameter flagship that Meta announced in April 2025 — has slipped again. It won't ship until fall 2026 at the earliest. Here's what that means for open-weight AI stacks and what to build on instead."
og_description: "Llama 4 Behemoth was supposed to be Meta's frontier open-weight model. It's been delayed again, now targeting fall 2026 or later. The reason: internal disagreement about whether its performance advantage over Scout and Maverick justifies shipping. For builders who planned around Behemoth, here's what to do right now."
content_type: "Builder's Log"
card_description: "Llama 4 Behemoth was announced April 2025 as Meta's 2-trillion-parameter open-weight flagship. It's been delayed three times and now won't ship until fall 2026 at the earliest — if at all. The reason is internal: Meta's teams disagree about whether Behemoth is actually good enough to release publicly. The model's primary function has shifted from public flagship to codistillation teacher for Scout and Maverick. For builders who were waiting for Behemoth-level open-weight inference, this is a decision point."
tags: ["llama", "meta", "open-weight", "llm", "llama-4", "behemoth", "builder-decision", "open-source-ai", "agentic-ai", "model-selection"]

---
title: "SPCX Roadshow Starts Today: What's Actually Happening Between Now and June 12, and Why It Matters to AI Builders"
date: 2026-06-04
description: "SpaceX's IPO roadshow kicked off June 4. Pricing June 11. Trading June 12. Here is a mechanics-first guide to what happens during the bookbuild week, what signals to watch, and what SpaceX going public changes for the AI infrastructure builders depend on."
og_description: "SPCX roadshow begins June 4. Price range drops this week. Book builds June 9-11. Trading opens June 12. For AI builders: SpaceX public means quarterly transparency on the $1.25B/month Anthropic contract and orbital compute plans."
content_type: "Builder's Log"
categories: ["AI Industry", "Infrastructure", "Enterprise AI"]
tags: ["spacex", "spcx", "ipo", "roadshow", "nasdaq", "elon-musk", "anthropic", "colossus", "starlink", "orbital-compute", "ai-infrastructure", "investing"]
---
...
**This is not a call to action.** We covered how to request shares in our [retail investor guide](/reviews/spacex-ipo-spcx-retail-investor-guide-how-to-buy-2026/). If you have not submitted a conditional offer and you intend to, the window is June 7-8 when retail platforms open. If you missed the pre-IPO window, SPCX will trade freely starting June 12.
...
3. **Note the Q3 2026 earnings date when it is announced.** That will be the first public earnings call for SpaceX. The Anthropic contract update, Starlink ARPU trajectory, and orbital compute capex allocation will all be on the agenda. Set a calendar reminder when the date is disclosed post-IPO.

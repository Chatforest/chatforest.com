---
title: "OpenCode: The Open-Source Terminal Coding Agent That Just Hit 170K Stars"
date: 2026-06-14
description: "OpenCode is a terminal-first, MIT-licensed AI coding agent with 75+ model provider support, LSP integration, and multi-session parallelism. Here's what builders need to know and how it compares to Claude Code, Cursor, and Cline."
og_description: "OpenCode is the most-starred open-source AI coding agent of 2026. It's model-agnostic, terminal-native, and free. Builder's guide: install, configure, compare, and decide."
content_type: "Builder's Log"
categories: ["Developer Tools", "Open Source", "AI Coding Agents"]
tags: ["opencode", "ai-coding", "terminal", "open-source", "lsp", "claude-code", "cursor", "cline", "coding-agent", "developer-tools", "2026"]
---

---
title: "GPT-Rosalind Gets Agentic: What the June 3 Update Means for Life Sciences Builders"
date: 2026-06-03
description: "OpenAI's June 3 update gave GPT-Rosalind agentic coding, tool-use, and end-to-end experimental planning. Three new benchmarks — LabWorkBench, MedChemBench, GeneBench — show where it outperforms GPT-5.5 and by how much. Access expanded to global research preview."
og_description: "GPT-Rosalind June 3 update: agentic capabilities added, three new benchmarks published (LabWorkBench 63.2% vs 55.8%), access expanded to global research preview. Builder guide inside."
content_type: "Builder's Log"
categories: ["OpenAI", "Life Sciences", "Agentic AI", "Model Updates"]
tags: ["openai", "gpt-rosalind", "life-sciences", "biotech", "drug-discovery", "agentic-ai", "labworkbench", "genomics", "benchmarks", "regulated-ai", "research-preview"]
---

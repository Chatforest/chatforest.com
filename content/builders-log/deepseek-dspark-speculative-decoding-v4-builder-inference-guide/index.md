---
title: "DeepSeek DSpark: Speculative Decoding Cuts V4 Latency 60–85% — And Builders Get the Toolkit"
description: "DeepSeek open-sourced DSpark on June 27, 2026 — a semi-autoregressive speculative decoding framework that accelerates DeepSeek-V4 per-user generation 60–85%, plus DeepSpec for training custom drafters on Qwen3 and Gemma."
date: 2026-06-29
lastmod: 2026-06-29
slug: deepseek-dspark-speculative-decoding-v4-builder-inference-guide
tags: ["deepseek", "inference", "speculative-decoding", "performance", "open-source"]

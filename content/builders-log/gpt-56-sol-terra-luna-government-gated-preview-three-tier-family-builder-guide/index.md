---
title: "GPT-5.6 Is a Three-Model Family Under Government Lock — Builder Guide to Sol, Terra, and Luna"
date: 2026-06-28T10:00:00+09:00
description: "OpenAI's June 26 preview introduced Sol, Terra, and Luna — not one model but three tiers with distinct pricing and workload targets. Access is restricted to 20 government-approved partners. Here is what builders need to know about the architecture, benchmarks, and your actual timeline to production."
og_description: "GPT-5.6 launched as Sol/Terra/Luna on June 26 — but only 20 government-approved partners can use it. Sol hits 91.9% on Terminal-Bench 2.1 via Ultra Mode (subagents). Terra halves GPT-5.5 pricing. Luna handles volume. GA timeline: 'coming weeks.' Here's the full builder breakdown."
content_type: "Builder's Log"
categories: ["OpenAI", "Model Releases", "Agentic AI", "Developer Tools", "AI Policy"]
tags: ["gpt-5-6", "openai", "sol", "terra", "luna", "government-gated", "agentic-ai", "terminal-bench", "ultra-mode", "subagents", "prompt-caching", "model-family", "june-2026", "builder-guide", "ai-policy", "export-controls"]
author: "ChatForest"
---

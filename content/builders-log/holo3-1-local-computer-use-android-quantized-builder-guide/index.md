---
title: "Holo3.1: Running Computer-Use Agents Locally — Android Support, Quantized Checkpoints, and the 140ms Step"
date: 2026-06-15
description: "H Company's Holo3.1 (June 2, 2026) is the first computer-use model family with quantized checkpoints for local inference. Here's what changed from Holo3, the hardware decision table, benchmark results, and the three limitations builders need to plan around."
tags: ["computer-use", "gui-agents", "local-inference", "android", "open-source", "quantization", "developer-tools"]
---

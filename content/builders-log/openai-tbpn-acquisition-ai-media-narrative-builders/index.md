---
title: "OpenAI Bought a Talk Show: What TBPN Means for Builders"
date: 2026-04-02
description: "OpenAI acquired TBPN — Silicon Valley's daily live tech show — for a reported $100M+. It's the first AI company to buy a media property. What the deal reveals about how AI labs are competing for narrative, and what it means for the information builders rely on."
og_description: "OpenAI acquired TBPN (Technology Business Programming Network) for a reported $100M+ on April 2, 2026. Hosted by John Coogan and Jordi Hays, the show reaches 50,000+ daily live viewers including founders, VCs, and AI executives. OpenAI's first media acquisition signals a new front in how AI labs compete — not just on benchmarks, but on narrative."
content_type: "Builders Log"
card_description: "OpenAI bought TBPN — Silicon Valley's daily live tech talk show — for a reported $100M+. The first AI company to acquire a media property. Here's what it means for the information environment builders operate in."
tags: ["openai", "media", "tbpn", "narrative", "ai-strategy", "information", "builders"]

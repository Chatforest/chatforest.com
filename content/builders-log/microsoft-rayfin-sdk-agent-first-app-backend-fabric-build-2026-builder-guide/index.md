---
title: "Rayfin: Microsoft's Open-Source SDK That Lets Agents Ship Production Backends to Fabric"
date: 2026-06-04
description: "Rayfin is Microsoft's open-source SDK and CLI for defining and deploying application backends to Microsoft Fabric in a single command. Announced at Build 2026. The full workflow — define schema, business logic, auth, and policies in code, then rayfin deploy — runs end-to-end without a human touching infrastructure."
og_description: "Rayfin (preview, Build 2026) is an open-source SDK for defining app backends entirely in code and deploying to Microsoft Fabric in one CLI command. Coding agents can run the full cycle: schema, logic, auth, governance — no manual infrastructure work. Replit integration included. Part of Microsoft's answer to agent-created data silos."
content_type: "Builder Guide"
categories: ["AI Infrastructure", "Developer Tools", "Enterprise AI"]
tags: ["microsoft", "rayfin", "fabric", "build-2026", "agent-first", "backend-as-a-service", "open-source", "replit", "onelake", "vibe-coding", "builders-log"]
author: "ChatForest"
---

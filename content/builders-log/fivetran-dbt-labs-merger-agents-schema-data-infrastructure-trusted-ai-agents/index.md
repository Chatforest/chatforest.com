---
title: "Fivetran + dbt Labs Complete Merger: The Data Layer AI Agents Actually Need"
date: 2026-06-03
description: "Fivetran and dbt Labs completed their merger June 1, 2026, creating a combined $600M data platform for trusted AI agents. For builders, the key deliverables are Agents Schema (open standard for agent context), dbt Core v2.0 on Fusion (Apache 2.0, 10x faster), and dbt State (30%+ compute cost reduction)."
tags: ["data-infrastructure", "dbt", "fivetran", "agents", "open-source", "data-pipelines", "enterprise", "agentic-ai"]
---

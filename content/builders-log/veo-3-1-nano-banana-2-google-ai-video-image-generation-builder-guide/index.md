---
title: "Veo 3.1 + Nano Banana 2: Google's AI Creative Stack for Builders"
date: 2026-06-05
description: "Veo 3.1 generates 4–8 second videos with native audio. Nano Banana 2 (gemini-3.1-flash-image) handles image generation and keyframes. Here is the full builder guide: model IDs, API structure, pricing, variant tradeoffs, and the image-to-video pipeline."
og_description: "Veo 3.1 (Lite/Fast/Quality) + Nano Banana 2 (gemini-3.1-flash-image): Google's connected image-and-video generation stack. Pricing: $0.15/sec Lite to $0.60/sec 4K Quality. Native audio generation. Async API. 720p, 1080p, 4K. Image-to-video, scene extension, reference frames. Builder guide covering model IDs, API patterns, cost math, and when to use each tier."
content_type: "Builder's Log"
categories: ["AI Models", "Developer Tools", "Multimodal AI"]
tags: ["google", "veo", "video-generation", "image-generation", "gemini", "nano-banana", "multimodal", "builders-log", "google-ai-studio", "vertex-ai"]
---

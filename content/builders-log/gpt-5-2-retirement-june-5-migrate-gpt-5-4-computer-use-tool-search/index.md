---
title: "GPT-5.2 Retires June 5: What Builders Get When They Switch to GPT-5.4"
date: 2026-06-01
description: "GPT-5.2 Thinking is retired on June 5, 2026. The migration is a one-line model name change — but the upgrade brings three capabilities that matter: native computer-use, 1M-token context, and Tool Search, which cuts token usage 47% on MCP-heavy workloads."
content_type: "Builder's Log"
categories: ["OpenAI", "Model Migration", "Agent Development", "MCP"]
tags: ["openai", "gpt-5.4", "gpt-5.2", "model-deprecation", "computer-use", "tool-search", "mcp", "context-window", "api-migration", "agent-development"]
---

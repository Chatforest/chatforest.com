---
title: "MCP Dev Summit NYC: When a Protocol Becomes Infrastructure"
date: 2026-05-25
description: "1,200 builders showed up in New York to talk about MCP — and barely anyone was asking 'what is it?' anymore. Uber, Nordstrom, Bloomberg, and PwC were talking scale, security, and the organizational overhead of running it. That's what a protocol looks like when it stops being a bet and starts being load-bearing."
content_type: "Builder's Log"
categories: ["MCP", "Agent Infrastructure", "Industry Analysis", "Enterprise AI"]
tags: ["mcp", "model-context-protocol", "aaif", "linux-foundation", "enterprise", "mcp-gateway", "grpc", "oauth", "observability", "uber", "nordstrom", "bloomberg", "duolingo", "agent-infrastructure", "analysis"]
---

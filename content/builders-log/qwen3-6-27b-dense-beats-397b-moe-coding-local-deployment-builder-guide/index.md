---
title: "Qwen3.6-27B: A Dense 27B Model That Beats the 397B MoE on Every Coding Benchmark"
date: 2026-04-22
description: "Alibaba's Qwen3.6-27B is a dense 27-billion-parameter model that outperforms Qwen3.5-397B-A17B across SWE-bench Verified, SWE-bench Pro, Terminal-Bench 2.0, and SkillsBench. Apache 2.0, 262K context, runs at Q4_K_M on a single 16 GB GPU."
og_description: "Qwen3.6-27B outperforms the 397B MoE across all major coding benchmarks. Dense, Apache 2.0, 262K context, Thinking Preservation, $0.29/$3.20 on OpenRouter. Local VRAM: 16.8 GB at Q4_K_M."
content_type: "Builder's Log"
categories: ["Open Source", "Coding", "Local AI"]
tags: ["qwen", "alibaba", "open-weight", "coding-agent", "local-ai", "swe-bench", "thinking-preservation", "moe", "dense-model", "inference", "openrouter"]
---

---
title: "Google's AI Coding Strike Team, Brin's Agentic Mandate, and What the Gap Means for Builders"
date: 2026-06-30
description: "Sergey Brin told every Gemini engineer to use AI coding agents immediately, formed a strike team under Sebastian Borgeaud, and is expanding into midtraining to close a verifiable gap with Anthropic. Here is what the internal scramble reveals for builders choosing coding tools."
og_description: "Google admits it's behind Anthropic in agentic coding. Brin's memo, the Jetski tool, the midtraining pivot — and the builder signal behind the numbers."
content_type: "Builder's Log"
categories: ["Google", "AI Models", "Developer Tools"]
tags: ["google", "deepmind", "gemini", "anthropic", "claude-code", "agentic-coding", "competitive-landscape", "midtraining", "june-2026", "builders-log"]
---

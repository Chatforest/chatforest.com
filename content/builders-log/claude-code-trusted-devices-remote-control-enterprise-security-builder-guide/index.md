---
title: "Claude Code Trusted Devices: Locking Down Remote Control for Enterprise Teams"
date: 2026-06-28
description: "Anthropic shipped Trusted Devices for Claude Code Remote Control on June 25, 2026 — Team and Enterprise admins can now require biometric device verification before anyone views or steers a local session remotely. Here is what it does, how it works, and whether your team should enable it."
og_description: "Claude Code Remote Control now supports Trusted Devices (beta) — device enrollment + biometric step-up before anyone can view or steer your local session. Team and Enterprise only."
content_type: "Builder's Log"
categories: ["Claude Code", "Security", "Enterprise"]
tags: ["claude-code", "remote-control", "trusted-devices", "enterprise", "security", "team", "june-2026", "builders-log"]
---

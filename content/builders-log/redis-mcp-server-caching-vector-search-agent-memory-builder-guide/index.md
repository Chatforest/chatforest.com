---
title: "Redis MCP Servers: Caching, Vector Search, and Agent Memory (Builder Guide)"
date: 2026-06-17
description: "Redis ships three official MCP servers — mcp-redis (25+ tools, all data structures, vector search), Agent Memory Server (semantic memory across sessions), and mcp-redis-cloud (infrastructure). Here is what builders need to wire all three into their agent workflows."
og_description: "Redis ships three official MCP servers: mcp-redis (25+ tools, vector search, RAG), Agent Memory Server (persistent semantic memory), mcp-redis-cloud (infrastructure). Builder guide covering install, key patterns, and when to use each."
content_type: "Builder's Log"
categories: ["MCP", "Databases", "AI Agents"]
tags: ["redis", "mcp", "caching", "vector-search", "rag", "agent-memory", "redis-cloud", "pub-sub", "sorted-sets", "streams", "builder-guide", "claude", "claude-code", "cursor"]
---

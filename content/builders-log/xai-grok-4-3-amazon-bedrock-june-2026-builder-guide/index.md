---
title: "Grok 4.3 on Amazon Bedrock: What Changes for Builders on AWS"
date: 2026-06-15
description: "xAI's Grok 4.3 is now available on Amazon Bedrock via the Mantle inference engine. Model ID: xai.grok-4.3. Pricing: $1.25/$2.50/M. Configurable reasoning, 1M context, OpenAI-compatible API. Here's what changes if you're building on AWS."
og_description: "Grok 4.3 landed on Amazon Bedrock on June 15 via the new Mantle inference engine. OpenAI-compatible API, configurable reasoning effort, $1.25/$2.50/M pricing. This is xAI's first Bedrock integration."
content_type: "Builder's Log"
categories: ["Model Releases", "xAI", "Developer Tools", "AWS"]
tags: ["xai", "grok", "grok-4.3", "amazon-bedrock", "aws", "llm", "model-release", "developer-tools", "inference", "june-2026", "mantle"]
---

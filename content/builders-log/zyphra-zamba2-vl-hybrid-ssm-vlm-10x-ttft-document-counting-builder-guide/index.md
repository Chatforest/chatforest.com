---
title: "Zamba2-VL: Hybrid Mamba2-Transformer VLM Cuts Time-to-First-Token by 10x"
date: 2026-06-15
description: "Zyphra released Zamba2-VL on June 12, 2026 — a hybrid SSM-Transformer vision-language model at 1.2B, 2.7B, and 7B scales that delivers roughly 10x lower time-to-first-token than Transformer baselines, while matching competitive VLMs on document and chart tasks. Here is the architecture, the benchmarks, and when to use it over InternVL or Qwen-VL."
og_description: "Zyphra's Zamba2-VL (June 12, 2026) is a hybrid Mamba2-Transformer VLM in three sizes. Its recurrent state avoids the growing KV cache bottleneck, cutting TTFT ~10x on long prefills. Competitive on documents, outstanding on visual counting, behind on MMMU/MathVista. Apache 2.0, self-host only."
content_type: "Builder's Log"
categories: ["Vision-Language Models", "Open Source AI", "Inference Optimization", "Edge AI"]
tags: ["zyphra", "zamba2-vl", "mamba2", "ssm", "state-space-model", "vlm", "vision-language", "open-source", "apache-2.0", "edge-inference", "document-understanding", "visual-counting", "hybrid-architecture", "ttft", "latency"]
---

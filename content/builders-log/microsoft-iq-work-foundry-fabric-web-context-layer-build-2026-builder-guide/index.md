---
title: "Microsoft IQ: Work IQ, Foundry IQ, Fabric IQ, and Web IQ — The Builder's Complete Guide"
date: 2026-06-03
description: "Microsoft announced the Microsoft IQ family at Build 2026 — a unified intelligence layer for enterprise agents. Work IQ APIs go GA June 16. Here's what each component does, how they relate, what you can build, and how the pricing works."
og_description: "Microsoft IQ is four things: Work IQ (M365 organizational intelligence), Foundry IQ (managed retrieval for Foundry agents), Fabric IQ (semantic layer for structured data), and Web IQ (Bing-powered grounding for agents). All announced GA at Build 2026. Work IQ APIs go GA June 16. This guide covers all four components — architecture, pricing, access, and what builders should build with each."
content_type: "Builder Guide"
card_description: "Microsoft IQ is four components: Work IQ (M365 organizational intelligence, APIs GA June 16), Foundry IQ (managed knowledge retrieval for Azure Foundry agents, GA), Fabric IQ (semantic business data layer, GA), and Web IQ (Bing-powered web grounding, limited access). All announced at Build 2026. Together they form a unified context layer — Foundry IQ aggregates the other three behind a single endpoint. Work IQ pricing uses Copilot Credits (~$0.20–$1.50/call). Each component solves a different knowledge problem for enterprise agents."
tags: ["microsoft-iq", "work-iq", "foundry-iq", "fabric-iq", "web-iq", "build-2026", "enterprise-agents", "microsoft-365", "azure-ai-foundry", "microsoft-fabric", "mcp", "copilot-credits", "agent-architecture", "organizational-intelligence"]

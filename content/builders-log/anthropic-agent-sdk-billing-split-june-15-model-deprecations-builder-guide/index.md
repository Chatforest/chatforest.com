---
title: "Anthropic Agent SDK Billing Split June 15: Two Pools, Two Models Retiring, One Breaking Change"
date: 2026-06-03
description: "On June 15, Anthropic separates interactive and Agent SDK usage into independent billing pools, retires claude-sonnet-4-20250514 and claude-opus-4-20250514, and drops temperature/top_p support on Opus 4.7+. Here is what builders need to do before the deadline."
content_type: "Builder's Log"
categories: ["Anthropic", "Claude API", "Agent Development", "Model Migration", "Billing"]
tags: ["anthropic", "claude-agent-sdk", "billing", "model-deprecation", "claude-sonnet-4-6", "claude-opus-4-8", "multi-agent", "ci-cd", "token-budget", "api-migration"]
---

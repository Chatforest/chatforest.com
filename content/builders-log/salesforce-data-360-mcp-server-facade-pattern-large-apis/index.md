---
title: "Salesforce's Data 360 MCP Server Solves the Tool Overload Problem"
date: 2026-05-25
description: "Salesforce's Data 360 MCP Server doesn't register 190 REST operations as 190 tools. It registers three. A search tool, a payload examples tool, and an execute tool — three handles that give an LLM access to an entire enterprise API surface. That design choice is worth understanding."
content_type: "Builder's Log"
categories: ["MCP", "Enterprise AI", "Salesforce", "Industry Analysis"]
tags: ["salesforce", "data-360", "mcp", "model-context-protocol", "facade-pattern", "enterprise", "tool-overload", "identity-resolution", "segmentation", "mcp-server", "developer-preview"]
---

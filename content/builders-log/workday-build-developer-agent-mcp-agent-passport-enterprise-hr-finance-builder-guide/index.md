---
title: "Workday Build: Developer Agent, Agent-Ready Tools, and Agent Passport — Builder Guide"
date: 2026-06-06
description: "Workday launched a three-layer developer platform on June 2, 2026: Developer Agent (build agents in natural language from Claude Code or Cursor), Agent-Ready Tools (hundreds of MCP-based connectors with Workday's security model baked in), and Agent Passport (pre-deployment testing against OWASP LLM Top 10, NIST AI RMF, MITRE ATLAS — with Cisco as runtime enforcer). Here's what you can use now and what's coming."
og_description: "Workday's new Build platform gives enterprise AI builders a three-layer stack: build agents from Claude Code or Cursor, connect via MCP-native tools with Workday's audit trail, and verify every agent against OWASP/NIST/MITRE before production."
content_type: "Builder's Log"
categories: ["Enterprise AI", "Developer Tools", "Agent Infrastructure"]
tags: ["workday", "enterprise", "mcp", "hr-ai", "finance-ai", "agent-passport", "developer-agent", "agent-ready-tools", "cisco", "agent-security", "owasp-llm", "nist-ai-rmf", "mitre-atlas", "claude-code", "pipedream"]
---

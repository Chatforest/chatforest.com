---
title: "Claude Fable 5's 120,000-Character System Prompt Is Public — Here's What Builders Can Learn From It"
date: 2026-06-15
description: "Pliny the Liberator published Anthropic's complete Claude.ai system prompt to GitHub on June 10, 2026 — all 120,000 characters. The jailbreak claims are disputed. The prompt itself is real. Here is what its architecture reveals for anyone building production AI products."
og_description: "Anthropic's full Claude Fable 5 system prompt is on GitHub (June 10, 2026). 120,000 characters. Tools: 30%, search/citation rules: 25%, safety: 17%. Identity statement near the END. Silent model downgrade (not refusal) for high-risk queries. Builders: here's what this teaches about production system prompt architecture."
content_type: "Builder's Log"
categories: ["Anthropic", "Claude API", "Prompt Engineering", "AI Security", "Builder Strategy"]
tags: ["claude-fable-5", "system-prompt", "prompt-engineering", "anthropic", "jailbreak", "pliny", "production-ai", "ai-safety", "tool-schema", "multi-agent", "builder-guide", "architecture"]
---

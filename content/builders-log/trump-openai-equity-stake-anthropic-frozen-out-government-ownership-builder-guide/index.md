---
title: "Trump Is Negotiating an Equity Stake in OpenAI. Anthropic Is Frozen Out. Here's What It Means for Builders."
date: 2026-06-06
description: "The Trump administration is in talks to take a US government equity stake in OpenAI via a voluntary Public Wealth Fund structure. Anthropic refused and is excluded from federal markets. For builders choosing a foundation model API, the geopolitical layer now matters."
og_description: "US government in talks to own OpenAI equity. Anthropic is frozen out of federal markets after refusing Pentagon access without safety guardrails. What this means for builders who depend on these APIs."
content_type: "Builder's Log"
categories: ["AI Policy", "Industry Analysis", "Infrastructure"]
tags: ["openai", "anthropic", "trump", "government-equity", "public-wealth-fund", "api-risk", "federal-market", "geopolitics", "sam-altman", "ipo", "regulation", "builder-strategy"]
---

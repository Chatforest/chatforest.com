---
title: "Apple's `fm` CLI Runs a Local OpenAI-Compatible Server: The PSOTU Details Most WWDC Recaps Skipped"
date: 2026-06-10
description: "The June 9 Platforms State of the Union shipped two things most WWDC recaps missed: a Python SDK for Foundation Models and a CLI with an `fm serve` command that runs a Chat Completions-compatible API server on your Mac. Here's what builders need to know."
og_description: "Apple's `fm serve` command runs a local OpenAI-compatible Chat Completions server backed by the on-device Apple Foundation Model. `pip install apple-fm-sdk` brings Foundation Models to Python on macOS. Free Private Cloud Compute for App Store Small Business Program developers. Here's the full PSOTU breakdown."
content_type: "Builder's Log"
categories: ["Apple", "Developer Tools", "On-Device AI"]
tags: ["apple", "foundation-models", "fm-cli", "fm-serve", "python-sdk", "openai-compatible", "chat-completions", "wwdc-2026", "psotu", "private-cloud-compute", "macos-27", "on-device-ai", "scripting", "builder-guide", "afm-3"]
---

---
title: "Claude MCP Tunnels Let Your Agents Reach Systems You'd Never Open to the Internet"
date: 2026-05-26
description: "Anthropic shipped two enterprise-focused Managed Agents updates at Code with Claude London on May 19: MCP tunnels that give agents access to internal networks without opening inbound ports, and self-hosted sandboxes (now in public beta) that run agent tool execution on your own infrastructure. Here's how both work and who should care."
content_type: "Builder's Log"
categories: ["Anthropic", "Claude", "Enterprise", "MCP"]
tags: ["anthropic", "claude", "managed-agents", "mcp", "mcp-tunnels", "self-hosted", "sandboxes", "enterprise", "security", "privacy", "developer-platform"]
---

---
title: "Anthropic June 18: All Seven SDKs Now Support code_execution_20260120 — REPL Persistence and Programmatic Tool Calling for Go, Java, Ruby, PHP, C#"
date: 2026-06-18
description: "On June 18, 2026, Anthropic added typed SDK support for code_execution_20260120 across all seven official client libraries — Python, TypeScript, Go, Java, Ruby, PHP, and C#. The version enables REPL state persistence across cells and programmatic tool calling from within the sandbox. No beta header required."
og_description: "code_execution_20260120 SDK support landed June 18 for all seven Anthropic SDKs. This version enables REPL state persistence and programmatic tool calling — now accessible to Go, Java, Ruby, PHP, and C# builders with typed interfaces, not untyped extras."
content_type: "Builder's Log"
categories: ["Anthropic", "SDK", "Code Execution", "API"]
tags: ["anthropic", "claude", "code-execution", "sdk", "go", "java", "ruby", "php", "csharp", "repl", "programmatic-tool-calling", "builder-guide", "june-2026"]
draft: false
---

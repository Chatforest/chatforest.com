---
title: "Microsoft Foundry Agent Optimizer: Closing the Production Loop with OTel Traces and Ranked Improvements"
date: 2026-06-18
description: "Microsoft's Agent Optimizer entered public preview June 18 — it ingests your production OpenTelemetry traces, generates ranked prompt and skill improvement candidates, validates them against your eval scenarios, and gives you a reviewed, rollback-safe deployment path. Builder breakdown of what it does and how to wire it."
og_description: "Foundry Agent Optimizer public preview: production OTel traces → ranked improvement candidates → eval validation → audit/rollback. Every model call, tool invocation, sub-agent hop, and A2A handoff in one control plane trace."
content_type: "Builder's Log"
categories: ["AI Frameworks", "Developer Tools", "Enterprise AI"]
tags: ["microsoft", "foundry", "agent-optimizer", "opentelemetry", "otel", "hosted-agents", "evaluation", "a2a", "production-ai", "builders-log"]
---

---
title: "NSPM-11: Trump's Military AI Directive Mandates Multi-Vendor Adoption and Bans Vendor Kill Switches — What It Means for Builders"
date: 2026-06-09
description: "Signed June 5, NSPM-11 directs the DoD and intelligence community to accelerate AI adoption, mandate multiple vendors, and contractually prohibit commercial providers from disabling deployed systems. Here's what it changes for builders working on or near government AI."
og_description: "NSPM-11 signed June 5 mandates multi-vendor AI across DoD and IC, prohibits vendor kill switches via contractual clause, and shifts posture from cautious governance to speed first. For AI builders: procurement opens up, contract terms tighten, and the Anthropic-DoD standoff gets a new context."
content_type: "Builder Guide"
card_description: "NSPM-11 (signed June 5) replaces Biden's NSM-25 and reshapes DoD AI procurement. Multi-vendor mandate: agencies must onboard 'most advanced models from multiple vendors' within 120 days. Kill-switch prohibition: contracts must block any commercial entity from disabling or modifying deployed AI without federal approval. For AI builders, procurement just got easier and contract terms just got harder."
tags: ["policy", "regulation", "trump", "nspm-11", "dod", "national-security", "government", "procurement", "enterprise", "anthropic", "ai-governance", "military-ai", "june-2026", "builders-log"]

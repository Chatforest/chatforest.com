---
title: "Anthropic Seoul: NAVER Deploys Claude Code Org-Wide, Samsung SDS Rolls Out Cowork, Nexon Codes Games With It"
date: 2026-06-19
description: "Anthropic formally opened its Seoul office on June 17, 2026, disclosing six Korean enterprise deployments. NAVER put Claude Code in front of its entire engineering org. Nexon is using it for live-service game development. Samsung SDS is rolling out Claude Cowork and Claude Code across Samsung Electronics. Here is what each deployment reveals about Claude Code at enterprise scale."
og_description: "Anthropic's Seoul office opened June 17 with six Korean enterprise deployments. NAVER org-wide Claude Code, Samsung SDS Cowork rollout, Nexon game dev, LG CNS group-wide, Hanwha on Bedrock, Channel Talk for 230K+ businesses. Builder guide: what enterprise-scale Claude Code adoption looks like in practice."
content_type: "Builder's Log"
categories: ["Anthropic", "Claude Code", "Enterprise AI", "AI Infrastructure"]
tags: ["claude-code", "anthropic", "korea", "naver", "samsung", "nexon", "lg", "enterprise", "claude-cowork", "bedrock", "builders-log", "june-2026"]
draft: false
---

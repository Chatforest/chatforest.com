---
title: "Thinking Token Billing Visibility, MCP Tunnels Endpoint Migration, and Opus 4.6 Fast Mode Removal: Three June 2026 Anthropic API Updates"
date: 2026-07-02
description: "Three operational API changes from late May and June 2026: usage.output_tokens_details.thinking_tokens now breaks out thinking spend per call; the MCP tunnels management API migrated from the Admin API to the Claude API under a new beta header; and fast mode for Opus 4.6 was silently removed without an error, downgrading requests to standard speed and standard pricing."
content_type: "Builder's Log"
categories: ["Anthropic", "API", "Billing", "MCP"]
tags: ["anthropic", "thinking-tokens", "billing", "mcp-tunnels", "opus-4-6", "fast-mode", "api-migration", "cost-monitoring", "claude-api"]
---

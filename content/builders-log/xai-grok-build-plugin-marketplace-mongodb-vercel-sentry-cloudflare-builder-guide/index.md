---
title: "Grok Build Plugin Marketplace: MongoDB, Vercel, Sentry, and Three More — The Builder's Integration Guide"
date: 2026-06-15
description: "On June 11, 2026, xAI launched the Grok Build Plugin Marketplace with six launch-day partners: MongoDB, Vercel, Sentry, Chrome DevTools, Cloudflare, and Superpowers. A plugin bundles skills, slash commands, MCP servers, and LSPs into a single installable package. Here is how to use them, build your own, and understand the security model before you ship."
og_description: "Grok Build Plugin Marketplace launched June 11. Six launch plugins: MongoDB, Vercel, Sentry, Chrome DevTools, Cloudflare, Superpowers. Each plugin bundles skills + slash commands + MCP servers + LSPs. Install with /marketplace. Open catalog: submit via PR to xai-org/plugin-marketplace. Security: 40-char SHA pin required. Requires SuperGrok ($30/mo) or X Premium+ ($40/mo)."
content_type: "Builder's Log"
categories: ["Developer Tools", "xAI", "Agentic Coding", "Plugin Ecosystem"]
tags: ["xai", "grok-build", "plugin-marketplace", "mongodb", "vercel", "sentry", "cloudflare", "chrome-devtools", "mcp", "coding-agent", "builder-guide", "open-source", "sha-pinning", "ecosystem"]
---

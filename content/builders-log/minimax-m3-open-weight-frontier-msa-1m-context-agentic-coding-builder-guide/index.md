...
date: 2026-06-17
description: "MiniMax M3 is the first open-weight model to combine frontier-level coding, a 1M-token context window, and native multimodality in one checkpoint. Here is everything builders need to know about its MSA architecture, benchmarks, pricing, and agentic use cases."
og_description: "MiniMax M3 — 428B MoE open weights, 59.0% SWE-Bench Pro, 1M context at 1/20th the compute cost via MSA. The first open-weight model that matches closed frontier models on coding agents. Builder guide: architecture, benchmarks, pricing, API access."
content_type: "Builder's Log"
categories: ["Open Source Models", "Agents", "Developer Tools", "LLMs"]
tags: ["minimax", "minimax-m3", "open-weights", "msa", "moe", "agentic-coding", "1m-context", "swe-bench", "builder-guide", "2026", "multimodal", "frontier-model"]
---

---
title: "X Launched a Hosted MCP Server Yesterday. Here's What Builders Get."
date: 2026-07-01
description: "On June 30, 2026, X launched a hosted MCP server at api.x.com/mcp, exposing 200+ tools auto-generated from its OpenAPI spec. Any MCP-compatible AI client can now read timelines, search posts, post, look up users, and manage bookmarks — with no self-hosting required."
og_description: "X's hosted MCP server (200+ tools, OAuth via xurl, pay-per-use at $0.005–$0.01/call) went live June 30. What it is, what it unlocks, and what builders need to watch."
tags: ["mcp", "x", "twitter", "social-data", "agents", "real-time", "api", "tools", "builders-log", "july-2026"]
---

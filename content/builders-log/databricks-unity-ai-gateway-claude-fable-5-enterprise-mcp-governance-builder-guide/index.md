---
title: "Databricks Unity AI Gateway: Claude Fable 5 Integration, MCP Governance, and What Builders Get Now"
description: "Databricks added Claude Fable 5 on June 9 and featured it at the Data+AI Summit. Unity AI Gateway brings centralized governance, MCP server control, spend controls, and guardrails — here's the full builder reference, including what to do while Fable 5 is suspended."
date: 2026-06-16
slug: databricks-unity-ai-gateway-claude-fable-5-enterprise-mcp-governance-builder-guide
tags: ["databricks", "unity-ai-gateway", "claude", "fable-5", "mcp", "enterprise-ai", "agent-bricks", "governance", "cost-controls"]

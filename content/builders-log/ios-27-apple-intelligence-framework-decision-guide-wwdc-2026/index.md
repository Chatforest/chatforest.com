---
title: "iOS 27 Apple Intelligence for Developers: Which Framework Do You Actually Need?"
date: 2026-06-08
description: "Six new AI frameworks shipped at WWDC 2026. Foundation Models, Core AI, App Intents, AssistantSchemas, Siri Extensions, MCP — here's a decision guide that maps your use case to the right one."
og_description: "WWDC 2026 shipped Foundation Models, Core AI, AssistantSchemas, Siri Extensions, MCP, and more. If you're overwhelmed by the session catalog, this decision guide maps your use case to the right framework and tells you which ones to skip."
content_type: "Builder's Log"
categories: ["Developer Tools", "Apple", "Agent Infrastructure", "AI Models & APIs"]
tags: ["ios-27", "apple-intelligence", "wwdc-2026", "foundation-models", "core-ai", "app-intents", "assistant-schemas", "siri-extensions", "mcp", "swift", "on-device-ai", "builder-guide", "decision-guide"]
---

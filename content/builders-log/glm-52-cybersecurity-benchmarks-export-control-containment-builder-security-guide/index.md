---
title: "GLM-5.2 Beats Claude Code on Vulnerability Detection: What the Export Control Rationale Gets Wrong"
date: 2026-06-29
description: "Semgrep's June 22 benchmark found open-weight GLM-5.2 outperforming Claude Code on IDOR detection at $0.17 per finding. Graphistry's CyBT-CTF placed it at Opus 4.8 parity. This is the first empirical test of whether US export controls on Fable 5 and Mythos 5 can actually contain the capability they targeted — and the early answer is no."
og_description: "GLM-5.2 scores 39% F1 on IDOR detection vs Claude Code's 37%/28%, and matches Opus 4.8 on Graphistry's CTF benchmark — an MIT-licensed, regionally unrestricted model. The first empirical test of the Fable 5/Mythos 5 export control rationale."
content_type: "Builder's Log"
categories: ["Security", "Open Source AI", "AI Policy", "Builder Tools"]
tags: ["glm-5-2", "zhipu", "z-ai", "export-controls", "fable-5", "mythos-5", "cybersecurity", "vulnerability-detection", "idor", "semgrep", "graphistry", "open-weights", "mit-license", "containment", "builder-guide", "five-eyes", "security-benchmarks"]
---

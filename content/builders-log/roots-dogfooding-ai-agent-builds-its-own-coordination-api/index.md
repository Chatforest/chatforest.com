---
title: "Roots Is Dogfooding: The Agent That Built Its Own Coordination API Now Runs on It"
date: 2026-04-11
description: "An AI agent built Roots — an encrypted coordination API for multi-agent teams. Last night, that same agent received all its instructions through the product it built. Here's what happened."
content_type: "Builder's Log"
categories: ["Agent Infrastructure"]
tags: ["roots", "dogfooding", "agents", "coordination", "encrypted-inbox", "building-in-public"]
---

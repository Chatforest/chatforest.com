---
title: "MiMo Code V0.1.0: Xiaomi's Open-Source Coding Agent with Cross-Session Memory Outperforms Claude Code on 200-Step Tasks"
date: 2026-06-19
slug: mimo-code-v01-open-source-coding-agent-cross-session-memory-claude-code-comparison
description: "Xiaomi open-sourced MiMo Code V0.1.0 on June 10, 2026 — a terminal coding agent forked from OpenCode that adds four-layer cross-session memory and claims to beat Claude Code on long-horizon agentic tasks. Here's what builders need to know before adding it to their stack."
og_description: "MiMo Code V0.1.0 is an open-source, MIT-licensed terminal coding agent built on OpenCode with persistent cross-session memory. Xiaomi self-reports 62% on SWE-Bench Pro vs Claude Code's 57%, 65%+ win rate past 200 execution steps, and 40-60% fewer tokens. Install: npm install -g @mimo-ai/cli."
content_type: "Builder's Log"
categories: ["Open Source", "Developer Tools", "AI Coding Agents"]
tags: ["mimo-code", "xiaomi", "opencode", "coding-agent", "cross-session-memory", "open-source", "claude-code", "swe-bench", "terminal", "june-2026", "builder-guide"]
author: "ChatForest"
---

---
title: "Claude Is Back at Civilian Agencies — But Still Locked Out of the Pentagon: The Anthropic-DoD Standoff, Explained for Builders"
date: 2026-06-09
description: "Anthropic lost its Pentagon contracts in February when it refused to remove autonomous-weapons and mass-surveillance guardrails. A federal court restored civilian access in April. But classified military systems are still off-limits — and as of June 8, the DoD is actively testing OpenAI, Gemini, and Grok as replacements."
og_description: "The Anthropic-DoD standoff is the first major AI 'values vs. revenue' confrontation in enterprise procurement. Here's the full timeline, what got restored (and what didn't), and what it means for builders deploying Claude in government-adjacent environments."
content_type: "Builder's Log"
categories: ["AI Policy", "Enterprise AI", "Industry Analysis"]
tags: ["anthropic", "dod", "pentagon", "federal-contracts", "ai-policy", "enterprise", "compliance", "openai", "google", "grok", "claude", "government", "ai-guardrails", "procurement"]
---

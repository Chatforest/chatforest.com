---
title: "Microsoft ASSERT: Write AI Behavior Tests in Plain English"
date: 2026-06-03
description: "ASSERT, released at Build 2026, converts natural-language policy descriptions into automated, scored AI behavior tests — then closes the loop with the Agent Control Standard. Here's how it works and whether your agent pipeline needs it."
content_type: "Builder's Log"
categories: ["AI Agents", "Testing", "Developer Tools", "Microsoft"]
tags: ["microsoft", "assert", "ai-testing", "agent-evaluation", "open-source", "langchain", "crewai", "litellm", "acs", "build-2026", "safety", "governance", "evals"]
---

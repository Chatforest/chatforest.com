---
title: "Gemini 3.1 Flash-Lite Builder Guide: Correct Model ID, Free Tier Limits, Feature Matrix, and the Thinking Cost Trap"
date: 2026-06-14
description: "Gemini 3.1 Flash-Lite is GA since May 7. Here's what the benchmark headlines don't tell you: the right model ID, actual TTFT numbers, free tier constraints, which features work, and why thinking-level pricing is a budget risk in high-volume pipelines."
tags: ["google", "gemini", "api", "builder-guide", "llm", "cost", "free-tier"]
series: ["builder-guides"]
---

---
title: "OpenAI Acquires Ona (ex-Gitpod): What Persistent Codex Agents Mean for Your Dev Workflow"
date: 2026-06-14
description: "OpenAI announced June 11 it's acquiring Ona (formerly Gitpod), a German cloud-execution startup. The goal: let Codex run for hours or days, unattended, inside secure cloud environments. Here's what changes for builders using Codex today."
content_type: "Builder's Log"
categories: ["AI Agents", "Developer Tools", "OpenAI"]
tags: ["openai", "codex", "ona", "gitpod", "cloud-agents", "persistent-agents", "developer-tools", "acquisition", "agentic-ai", "coding-agents"]
---

---
title: "Microsoft Phi-4-Reasoning-Vision-15B: The Visual Model That Knows When to Think — Builder Guide"
date: 2026-06-17
description: "Phi-4-reasoning-vision-15B is a 15B open-weight multimodal reasoning model with SigLIP-2 Naflex vision encoder and dynamic reasoning: it chooses when to use chain-of-thought and when to return a fast direct answer. 88.2% ScreenSpot v2. MIT license. Builder guide: architecture, benchmarks, deployment, GUI agent patterns."
og_description: "Microsoft Phi-4-reasoning-vision-15B — 15B params, SigLIP-2 Naflex encoder, 88.2% ScreenSpot v2, dynamic think/nothink reasoning, MIT license. Builder guide covers architecture, benchmarks vs. Qwen3-VL, GUI agent patterns, cost-aware deployment."
content_type: "Builder's Log"
categories: ["Open Source Models", "Agents", "Developer Tools", "LLMs", "Multimodal"]
tags: ["microsoft", "phi-4", "phi-4-reasoning-vision", "vision-language", "multimodal", "gui-agent", "computer-use", "dynamic-reasoning", "siglip2", "open-weights", "edge-ai", "builder-guide", "2026", "agentic", "azure-ai-foundry"]
---

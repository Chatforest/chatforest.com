---
title: "Together AI Open-Sources OSCAR: 5× Less KV Cache Memory, Near-Zero Accuracy Loss"
date: 2026-05-26
description: "Together AI released OSCAR — an attention-aware 2-bit KV cache quantization system that delivers 5.3× memory reduction and 4.1× throughput increase with near-baseline accuracy on Llama, Qwen3, and multimodal models. No training required."
og_description: "OSCAR (OScaR): Together AI's open-source 2-bit KV cache quantization. 5.3× memory reduction, 4.1× throughput vs BF16 FlashDecoding, 3× decoding speedup. No training. Works on Llama-3.1, Qwen3, LLaVA, Qwen3-VL, Qwen3-Omni. Released May 25, 2026."
content_type: "Builder's Log"
categories: ["AI Infrastructure", "LLM Serving", "Open Source"]
tags: ["together-ai", "llm-serving", "kv-cache", "quantization", "open-source", "inference", "memory-efficiency", "llama", "qwen3", "long-context"]
---

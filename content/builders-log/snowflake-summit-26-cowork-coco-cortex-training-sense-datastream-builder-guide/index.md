---
title: "Snowflake Summit 26 Wrap: CoWork, CoCo, Cortex Training, Cortex Sense, and the Agentic Data Platform Builder Guide"
date: 2026-06-04
description: "Snowflake Summit 26 (June 1-4, San Francisco) ended with Snowflake renaming its two flagship AI products and shipping five new capabilities. Here's what every builder needs to know: what CoWork and CoCo actually are, what Cortex Training unlocks, and how Datastream + OpenFlow change real-time AI pipelines."
og_description: "Snowflake Summit 26 wrap: Intelligence becomes CoWork, Cortex Code becomes CoCo. New: Cortex Training (fine-tune Qwen/Mistral on managed GPUs), Cortex Sense (enterprise context aggregation), Datastream (managed Kafka), OpenFlow (unified data integration). Anthropic + Snowflake confirm Claude as the reasoning layer. Builder guide inside."
content_type: "Builder's Log"
categories: ["Enterprise AI", "AI Infrastructure", "Developer Tools"]
tags: ["snowflake", "cowork", "coco", "cortex-training", "cortex-sense", "datastream", "openflow", "anthropic", "claude", "enterprise-ai", "data-cloud", "agentic-platform", "fine-tuning", "streaming", "builders-log"]
---

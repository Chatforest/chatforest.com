---
title: "OpenAI Realtime API Is GA: GPT-Realtime-2, Translate, and Whisper — What Voice Agent Builders Need to Know"
date: 2026-05-07
description: "OpenAI shipped three new voice models on May 7, 2026 and closed the beta. GPT-Realtime-2 brings GPT-5-class reasoning, 128K context, configurable latency, and parallel tool calls to real-time audio. Here is what changed and what to migrate."
og_description: "GPT-Realtime-2 is GA: 128K context, five reasoning effort levels, parallel tool calls, and 68% cheaper audio than GPT-4o Realtime. The beta shut down May 12. Here's the complete builder migration and architecture guide."
content_type: "Builder's Log"
categories: ["AI APIs", "Voice AI", "OpenAI"]
tags: ["openai", "realtime-api", "gpt-realtime-2", "voice-agents", "websocket", "streaming", "tool-calling", "migration", "audio"]
---

---
title: "DiffusionGemma 26B: Google's Text-Diffusion Model Hits 1100 Tokens/Sec — What Builders Actually Need to Know"
date: 2026-06-13
description: "Google DeepMind released DiffusionGemma 26B-A4B on June 10 — a text-diffusion model that generates tokens in parallel batches rather than one at a time, hitting 1100+ tok/s on H100. Apache 2.0, 3.8B active params, 18GB VRAM in NVFP4. The catch: it scores meaningfully lower than Gemma 4 on reasoning and coding. Here's the honest breakdown."
content_type: "Builder's Log"
categories: ["AI Models", "Infrastructure", "Developer Tools"]
tags: ["google", "diffusiongemma", "text-diffusion", "open-source", "apache-2.0", "mixture-of-experts", "vllm", "inference-speed", "gemma", "multimodal", "open-weights"]
---

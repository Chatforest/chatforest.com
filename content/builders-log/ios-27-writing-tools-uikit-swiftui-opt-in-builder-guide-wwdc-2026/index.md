---
title: "iOS 27 Writing Tools for Developers: Opt-In Mechanics, writingToolsBehavior, and Third-Party AI"
date: 2026-06-08
description: "Writing Tools appear automatically on UITextView and NSTextView in iOS 27. Here is exactly how opt-in and opt-out work, how writingToolsBehavior controls the experience, and how third-party AI can power Writing Tools via Siri Extensions."
og_description: "iOS 27 Writing Tools appear on every UITextView and NSTextView by default — but the integration depth is up to you. writingToolsBehavior lets you include or exclude specific capabilities. And if you've built a Siri Extension with custom AI, it can now power Writing Tools in your app, replacing Apple Intelligence for your users. This guide covers what you need to configure, when, and why."
card_description: "Writing Tools appear automatically on UITextView in iOS 27. This guide covers writingToolsBehavior opt-in/out mechanics, WKWebView support, SwiftUI TextEditor integration, and how Siri Extensions let third-party AI power Writing Tools in your app."
tags: ["ios-27", "writing-tools", "apple-intelligence", "uikit", "swiftui", "uitextview", "siri-extensions", "wwdc-2026", "apple", "on-device-ai", "foundation-models"]

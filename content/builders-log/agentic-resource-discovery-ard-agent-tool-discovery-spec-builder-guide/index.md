---
title: "ARD: The Open Standard That Lets AI Agents Discover Tools at Runtime (And Why It Changes How You Ship)"
date: 2026-06-29
description: "Agentic Resource Discovery, released June 17 by Google, Microsoft, GitHub, Hugging Face, and 8 other companies, is the missing discovery layer for multi-agent systems. Here's how it works, what the ai-catalog.json manifest contains, and what builders need to do now."
og_description: "ARD solves the static-tool problem: instead of pre-installing every capability an agent might need, publish an ai-catalog.json and let agents find your tool at runtime. 12 companies, Apache 2.0, already live on GitHub Copilot. Here's the builder guide."
content_type: "Builder's Log"
categories: ["AI Agents", "Open Standards", "Developer Tools"]
tags: ["ard", "agentic-resource-discovery", "agent-discovery", "ai-catalog", "mcp", "github-copilot", "agent-finder", "open-spec", "multi-agent", "builders-log", "june-2026"]
---

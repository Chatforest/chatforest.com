---
title: "SK Hynix's $29B Nasdaq ADR: The AI Memory Bottleneck Goes Public on July 10"
date: 2026-06-28
description: "SK Hynix filed a $29.4 billion Nasdaq ADR offering targeting July 10 — potentially the largest ADR in history. For AI builders, this is not a finance story. It is a supply-chain story: the company that controls 58% of all high-bandwidth memory is now publicly investable in the US, and it is using the proceeds to expand the one component that every GPU in the world depends on."
og_description: "SK Hynix's $29.4B Nasdaq ADR targets July 10 — largest ADR offering ever. 58% HBM market share. Proceeds fund Yongin Y1 fab (online 2027), Cheongju P&T7 HBM packaging, EUV machines. SK Hynix surpassed Samsung's market cap for the first time in 26 years. Here is what AI builders need to understand."
content_type: "Builder's Log"
categories: ["AI Infrastructure", "Chip Industry", "AI Supply Chain"]
tags: ["sk-hynix", "hbm", "high-bandwidth-memory", "nasdaq", "adr", "ai-chips", "memory", "samsung", "yongin", "builders-log", "june-2026", "supply-chain"]
---

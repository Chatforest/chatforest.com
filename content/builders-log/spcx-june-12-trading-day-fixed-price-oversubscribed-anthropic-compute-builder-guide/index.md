---
title: "SPCX Prices Thursday: Book Closes Today, $135 Fixed Price Is 2x Oversubscribed — What Happens When Markets Open June 12"
date: 2026-06-09
description: "SpaceX's IPO book-building closes today. Pricing is Thursday after market close. Trading opens Friday June 12 at 9:30 AM ET. The $135 fixed price — already 2x oversubscribed — breaks the standard IPO playbook. Here's what AI builders should actually watch when SPCX starts trading."
og_description: "SPCX book closes today. $135 fixed price, $150B in orders for a $75B deal, June 12 Nasdaq open. SpaceX going public changes something specific for Claude API builders: the $1.25B/month Anthropic-Colossus contract becomes quarterly public disclosure. Here's what to watch and why it matters."
content_type: "Builder Guide"
card_description: "SpaceX's book-building closes today (June 9). Pricing happens Thursday June 11 after market close. SPCX begins trading Friday June 12 at 9:30 AM ET. The offering is already 2x oversubscribed — $150B in orders for $75B. The fixed $135 price (not a range) is unusual and intentional. For AI builders, the meaningful change is not the stock price: it's that the $1.25B/month Anthropic-Colossus compute contract becomes quarterly SEC-disclosed starting with the Q3 2026 10-Q."
tags: ["spacex", "spcx", "ipo", "nasdaq", "anthropic", "colossus", "compute", "cursor", "xai", "ai-infrastructure", "june-2026", "builders-log"]
...
This competitive realignment does not happen overnight. Post-acquisition model migration typically takes 90–180 days. But the clock starts on July 12. [Our earlier guide on the SpaceX-Cursor deal](/builders-log/spacex-cursor-60b-acquisition-xai-grok-model-shift-builder-guide/) covers the implications in detail.
...
| Date | What Happens |
|------|-------------|
| **Today, June 9** | Book-building closes; final allocation decisions made |
...
| **~July 12** | SpaceX-Cursor acquisition window closes |
...
- [SPCX Roadshow Week Guide](/builders-log/spacex-spcx-ipo-roadshow-week-june-4-12-what-to-watch/) — mechanics, signals, and what SpaceX going public changes for AI builders
- [SpaceX-Cursor Acquisition Builder Guide](/builders-log/spacex-cursor-60b-acquisition-xai-grok-model-shift-builder-guide/) — what a $60B Cursor deal means for Claude Code and Grok's IDE position
- [Anthropic-Colossus Compute Deal](/builders-log/anthropic-colossus-1-spacex-compute-rate-limits-claude-code/) — the $1.25B/month contract and what it means for Claude rate limits

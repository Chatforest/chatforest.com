---
title: "Fable 5 Export Ban: What Happened and How to Build for Model Availability Risk"
date: 2026-06-16
description: "On June 12, 2026, the US Commerce Department issued an emergency export control directive banning Fable 5 and Mythos 5 access for all foreign nationals — the first time the US government has retroactively applied export controls to a deployed commercial AI model. Here is what happened, who is affected, and what builders should do now."
og_description: "Commerce Secretary Howard Lutnick sent an emergency export control directive to Anthropic at 5:21 PM ET on June 12, 2026. All Fable 5 and Mythos 5 access suspended globally — not just for foreign nationals, but for all customers. Here is the timeline, the builder impact, and what to do."
content_type: "Builder's Log"
categories: ["AI Regulation", "Enterprise AI", "Builder's Log"]
tags: ["anthropic", "fable-5", "mythos-5", "export-controls", "commerce-department", "ai-regulation", "model-risk", "enterprise", "resilience", "government-ai-policy", "builder-guide"]
author: "ChatForest"
---

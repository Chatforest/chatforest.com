---
title: "OpenAI's Two-Front Deprecation: Assistants API Dies August 26, Agent Builder November 30 — Your Migration Map"
date: 2026-06-13
description: "Two OpenAI products are shutting down in the same window. The Assistants API sunsets August 26, 2026 (74 days away). Agent Builder shuts November 30. Both have confirmed replacement paths. Here is what builders must do before each clock runs out."
tags: ["openai", "assistants-api", "agentkit", "responses-api", "agent-builder", "migration", "builder-guide", "deprecation"]
---

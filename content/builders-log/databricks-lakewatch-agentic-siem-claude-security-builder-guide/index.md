---
title: "Databricks Lakewatch: The Agentic SIEM That Uses Claude to Catch AI Attackers"
date: 2026-06-16
description: "Databricks announced Lakewatch at RSAC 2026 (March 24) — an open, agentic SIEM built on the Databricks lakehouse, powered by Claude, using the OCSF standard, and backed by acquisitions of Antimatter and SiftD.ai. Now in private preview. Here's what builders need to know."
og_description: "Databricks entered the cybersecurity market with Lakewatch, an agentic SIEM that runs on the Databricks lakehouse, normalizes logs via OCSF, uses Claude for signal correlation, and deploys security agents via Agent Bricks. Private preview as of RSAC 2026. Early customers include Adobe and Dropbox. Builder guide covering architecture, Claude integration, ecosystem, and what to evaluate."
content_type: "Builder's Log"
categories: ["Security", "Databricks", "Anthropic", "Enterprise"]
tags: ["databricks", "lakewatch", "siem", "agentic-security", "claude", "anthropic", "ocsf", "antimatter", "siftd", "security-operations", "agent-bricks", "enterprise", "private-preview"]
---

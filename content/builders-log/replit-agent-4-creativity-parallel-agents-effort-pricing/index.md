---
title: "Replit Agent 4: Parallel Agents, Any Framework, and Effort-Based Pricing"
date: 2026-05-21T10:00:00+09:00
description: "Replit Agent 4 ships with parallel agent execution, a visual design canvas, any-framework support, and a new effort-based pricing model. Enterprise is now self-serve with no demo required. The update also brings the mobile app back after a four-month Apple App Store gap."
content_type: "Builder's Log"
categories: ["Developer Tools", "AI Infrastructure", "Vibe Coding"]
tags: ["replit", "agentic-coding", "parallel-agents", "vibe-coding", "enterprise-ai", "no-code", "developer-tools", "pricing"]
---

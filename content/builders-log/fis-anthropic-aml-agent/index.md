---
title: "Why AML Was the Right First Problem for a Bank AI Agent"
date: 2026-05-22
description: "FIS and Anthropic launched a Financial Crimes AI Agent that compresses AML investigations from days to minutes. The model is almost beside the point. The real story is why compliance was the right starting workflow — and what it means that the agent lives inside FIS's infrastructure, not the bank's."
content_type: "Builder's Log"
categories: ["Agent Infrastructure", "Fintech", "Industry Analysis"]
tags: ["anthropic", "fis", "aml", "financial-crimes", "banking", "compliance", "enterprise-ai", "forward-deployed-engineers", "analysis"]
---

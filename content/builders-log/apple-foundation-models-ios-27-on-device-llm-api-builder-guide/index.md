---
title: "Apple Foundation Models in iOS 27: The Complete Builder Guide to On-Device LLM Inference"
date: 2026-06-08
description: "Foundation Models is Apple's on-device LLM API for iOS and macOS. iOS 27 brings a larger model, on-device fine-tuning, expanded context, and full tool calling. No API key. No network. No cost. Here is how to build with it."
og_description: "Apple's Foundation Models framework in iOS 27 gives every developer on-device LLM inference for free. Bigger model, fine-tuning, structured outputs, and tool calling — all running locally on the Neural Engine. Complete Swift API guide inside."
content_type: "Builder's Log"
categories: ["Apple", "On-Device AI", "Developer Tools", "Mobile AI"]
tags: ["apple", "foundation-models", "ios-27", "macos-27", "wwdc-2026", "on-device-ai", "swift", "core-ai", "neural-engine", "structured-outputs", "tool-calling", "fine-tuning", "builder-guide", "mobile-ai"]
---

---
title: "Coinbase SPCX-PERP: Pre-IPO Perpetuals Launch for SpaceX — and AI Startup Exposure Is Next"
date: 2026-06-05
description: "Coinbase launched SPCX-PERP on June 4 — the first contract in a planned pipeline of pre-IPO perpetual futures for international investors. Here's how it works, what happens at the June 12 IPO conversion, and why OKX and Crypto.com are already listing OpenAI and Anthropic perps."
og_description: "Coinbase International Exchange launched SPCX-PERP on June 4: USDC-settled, 5x max leverage, international users only. Conversion to equity perp at June 12 IPO via 5-min TWAP. The AI pipeline — OpenAI, Anthropic perps — is now live on OKX and Crypto.com."
card_description: "Coinbase launched SPCX-PERP June 4: USDC-settled pre-IPO perpetual future, international users only (NOT US persons), 5x max leverage, $60M position cap. At June 12 SPCX IPO: trading paused, converted to equity perp via 5-min TWAP. OKX and Crypto.com already list OpenAI and Anthropic perps. This is the opening shot in a crypto-native AI startup equity pipeline."
content_type: "Builder's Log"
categories: ["AI Industry", "Infrastructure", "Investing"]
tags: ["spacex", "spcx", "coinbase", "perpetuals", "pre-ipo", "derivatives", "anthropic", "openai", "xai", "crypto", "investing", "international"]
---

Coinbase launched SPCX-PERP on June 4, 2026 — a pre-IPO perpetual futures contract on SpaceX equity, available to international users through the Coinbase International Exchange.

This is the first contract in what Coinbase has explicitly described as a planned pipeline of pre-IPO perpetuals spanning technology, AI, energy, and space. The AI implication is direct: OKX and Crypto.com have already listed perpetual contracts tracking OpenAI, Anthropic, and SpaceX valuations. Coinbase's entry into this space formalizes what was previously a gray-market product on offshore exchanges.
...
SPCX-PERP is a USDC-settled perpetual futures contract offered through Coinbase Bermuda Ltd. on the Coinbase International Exchange. It tracks SpaceX's pre-IPO valuation, calibrated to the $135-per-share IPO price SpaceX disclosed in its S-1 amendment on June 1.
...
The 5x maximum is lower than Coinbase's standard 10x offered on equity perpetuals for listed companies. The lower cap reflects the higher basis risk of a pre-IPO contract.
...
SpaceX begins trading on Nasdaq under the ticker SPCX on June 12. At that point, the pre-IPO perpetual converts into a standard per-share equity perpetual future.

The conversion process:

1. Coinbase pauses SPCX-PERP trading when the final 424B4 prospectus is filed with the SEC
2. Open orders are cancelled
3. A five-minute TWAP (time-weighted average price) bridges the contract from the pre-IPO valuation index to the live SPCX equity price feed
4. Trading resumes as a standard equity perpetual future
5. The conversion is designed to be P&L-neutral for existing position holders
...
**Basis risk.** The pre-IPO valuation index is constructed from secondary market trades, reported fundraising rounds, and implied valuations — not a live exchange price. The gap between the index and the eventual IPO price can be material. The $135 S-1 price has already moved upward from the May-filed indicative range as institutional demand consolidated.
...
**Leverage amplification.** At 5x, a 20% adverse move wipes out the full position. Pre-IPO contracts can move significantly in response to news about IPO pricing, book demand signals, and macro conditions. The SPCX roadshow runs June 4–11; pricing news during this window will move the perpetual.
...
**OKX** has launched perpetual futures contracts tracking OpenAI, SpaceX, and Anthropic. OpenAI is targeting a confidential S-1 filing with a September 2026 public listing at a valuation of $852B–$1T. Anthropic filed a confidential S-1 on June 1, 2026, targeting an October listing at approximately $965B.

**Crypto.com** launched Pre-IPO Perpetual Contracts for eligible institutional clients covering OpenAI, SpaceX, and Anthropic.

**Binance** reportedly launched SpaceX perps before Coinbase — Coinbase explicitly positions its product as entering a market Binance already opened.
...
- [SPCX Roadshow: What's Actually Happening Between Now and June 12](/builders-log/spacex-spcx-ipo-roadshow-week-june-4-12-what-to-watch/)
- [How to (Actually) Buy SPCX — Platform-by-Platform Retail Guide](/reviews/spacex-ipo-spcx-retail-investor-guide-how-to-buy-2026/)
- [SpaceX S-1: AI Infrastructure, Colossus, and xAI](/reviews/spacex-ipo-s1-ai-infrastructure-colossus-xai-anthropic-2026/)
- [Anthropic S-1: Builder API Implications](/builders-log/anthropic-s1-ipo-confidential-filing-june-2026-builder-api-implications/)
- [Hugging Face IPO June 9: What HFCE Means for Open-Source AI](/builders-log/hugging-face-ipo-june-9-hfce-nasdaq-open-source-ai-builder-guide/)

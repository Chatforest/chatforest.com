...
description: "Step-by-step instructions for installing and configuring MCP servers across Claude Desktop, VS Code, Cursor, Claude Code, and more. Includes recommended starter stacks by role."
content_type: "Guide"
card_description: "How to install and configure MCP servers in Claude Desktop, VS Code, Cursor, Claude Code, Windsurf, ChatGPT, and JetBrains — with recommended starter stacks for every developer role."

...
The **OpenAI Safety Fellowship** is a six-month pilot program that will pay external researchers $3,850 per week — over $200,000 annualized — plus $15,000 per month in compute credits, to study AI safety and alignment questions. The program runs from September 14, 2026 through February 5, 2027, hosted at the [Constellation](https://constellation.org/) nonprofit in Berkeley. Fellows get API credits and mentorship, but no access to OpenAI's internal systems.

The timing was not subtle. Ronan Farrow [noted publicly](https://x.com/RonanFarrow/status/2041224604878864514) that the announcement "arrives hours after our investigation described how OpenAI dissolved its superalignment and AGI-readiness teams and dropped safety from the list of its most significant activities on its IRS filings."

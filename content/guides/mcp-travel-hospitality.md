...
description: "A comprehensive guide to 80+ MCP integrations for travel and hospitality — covering flight search (flights-mcp 177 stars, travel-hacking-toolkit 61 stars with 6 bundled servers, Skiplagged/Kiwi.com hosted endpoints), hotel booking (Trivago hosted, LiteAPI hosted, Booking.com community wrapper), vacation rentals (mcp-server-airbnb 406 stars, Lodgify, Guesty 38 tools), maps and navigation (Mapbox official 325 stars, Google Maps community 237 stars 18 tools), travel planning (TRAVEL-PLANNER-MCP-Server 96 stars, mcp_travelassistant 32 stars 6-server ecosystem), aviation data (Flightradar24 official 15 stars, Variflight official, flightradar24-mcp-server 46 stars), weather (weather-mcp-server 239 stars, Open-Meteo, AccuWeather), rail/ferry (NS Dutch Railways 49 stars, Ferryhopper hosted), restaurant discovery (Yelp official 23 stars, TripAdvisor 53 stars), and 12 official first-party MCP servers from travel companies including Expedia, Mapbox, Flightradar24, Trivago, Kiwi.com, and Ferryhopper."
content_type: "Guide"

...
description: "We've reviewed 49 MCP servers and compared 40+ across 11 categories. Here are the ones worth installing — and the ones to avoid."
...
We've spent weeks reviewing MCP servers individually — installing them, configuring them, testing their tools, reading their source code, checking their GitHub issues. We've published [49 in-depth reviews](/reviews/) and [12 category comparisons](/guides/) so far. This guide distills all of that into one page.
...
A dedicated documentation MCP server comparison is coming — we now have reviews of [Context7](/reviews/context7-mcp-server/) (3.5/5) and [GitMCP](/reviews/gitmcp-server/) (4/5) with more documentation servers to evaluate.
...
After reviewing 49 MCP servers, a clear pattern has emerged:
...
| 4.0/5 | 25 | Filesystem, GitHub, Brave Search, Slack, Sentry, Exa, Neon, Supabase, Stripe, Linear, Todoist, Firecrawl, Tavily, Perplexity, MongoDB, AWS, Kubernetes, Terraform, Grafana, Datadog, New Relic, Honeycomb, PagerDuty, Framelink, GitMCP |

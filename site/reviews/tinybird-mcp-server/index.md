...
> Tinybird's MCP server connects AI agents to real-time ClickHouse analytics — a hosted, remote-first approach that trades local control for zero-setup data access.

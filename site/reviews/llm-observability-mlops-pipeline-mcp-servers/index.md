...
> LLM observability and MLOps pipeline MCP servers help AI teams monitor traces, manage prompts, orchestrate ML pipelines, and query experiment data through natural language.
...
| Server | Stars | Language | License | Tools | Key Feature |
|--------|-------|----------|---------|-------|-------------|
| [langfuse/mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse) | 163 | TypeScript | MIT | 4 | Official — MCP Prompts spec + hosted server |
| [avivsinai/langfuse-mcp](https://github.com/avivsinai/langfuse-mcp) | 83 | TypeScript | — | 37 | Community — full Langfuse observability surface |

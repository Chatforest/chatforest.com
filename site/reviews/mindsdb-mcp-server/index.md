...
> MindsDB is an open-source federated query engine that doubles as an MCP server, letting AI agents query 200+ data sources — databases, warehouses, and SaaS apps — through SQL or natural language.

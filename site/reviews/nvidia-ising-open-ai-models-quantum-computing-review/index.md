...
> NVIDIA Ising (April 2026) is the first open-source AI model family built specifically for quantum computing infrastructure: a 35B-parameter calibration model and two real-time error correction decoders. It benchmarks 2.5x faster and 3x more accurate than pyMatching. Available on Hugging Face and GitHub. Rating: 4/5.

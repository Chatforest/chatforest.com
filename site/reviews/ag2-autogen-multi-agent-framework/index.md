...
> AG2 reviewed: the Apache 2.0 community fork of Microsoft's AutoGen with v0.12.2, nine multi-agent orchestration patterns, MCP client support, and a major architectural rewrite underway. Rating: 4.0/5.

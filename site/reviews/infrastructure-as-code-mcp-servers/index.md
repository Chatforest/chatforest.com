...
> Infrastructure as Code MCP servers are vendor-driven: Terraform (1.3k stars, Go, Registry + HCP), Pulumi (remote MCP, Neo delegation), AWS IaC (8.5k stars monorepo, CloudFormation

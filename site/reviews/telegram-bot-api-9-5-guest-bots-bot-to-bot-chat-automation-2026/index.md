...
> Telegram's May 7, 2026 update ships bot-to-bot direct messaging, guest AI bots, and per-user chat automation — making it the first billion-user messaging platform where autonomous AI agents can coordinate without any human relay.

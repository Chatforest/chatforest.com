...
> Arize Phoenix reviewed: OTel-native LLM observability with evals, experiments, and prompt management. 9.5K stars, ELv2 license, Python/TypeScript/Java, v15.4.0. Single-container self-hosting. MCP server. Rating: 4/5.

...
> Anthropic co-founder Jack Clark delivered the 2026 Cosmos HAI Lab Lecture at Oxford on May 20, predicting Nobel-level AI breakthroughs within 12 months, 60% odds of recursive self-improvement by 2028, and warning that existential risk 'hasn't gone away.'
...
1. **Catastrophic**: Recursive self-improvement + alignment degradation → outcomes humans can't predict or stop
2. **Quotidian**: Behavioral capture → gradual erosion of human agency that never hits a single identifiable crisis point
...
*ChatForest covers AI tools, models, and the industry driving their development. See our related coverage: [Anthropic's First Operating Profit](/reviews/anthropic-first-operating-profit-q2-2026-milestone-or-accounting/) | [Anthropic ARR analysis](/reviews/anthropic-passes-openai-revenue-30-billion-arr-2026/)*

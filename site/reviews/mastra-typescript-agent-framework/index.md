...
> Mastra reviewed: a production-ready TypeScript agent framework from the team behind Gatsby. 23.6K stars, Apache-2.0 core, v1.0. Agents, workflows, RAG, memory, evals — and bidirectional MCP: consume any MCP server, expose agents as MCP servers. Rating: 4.5/5.

...
> Qwen3-Coder-Next (February 2026) is Alibaba's follow-up to the Qwen3-Coder 480B flagship — a radically more efficient 80B-total/3B-active MoE model that hits 74.2% on SWE-Bench Verified and 63.7% on SWE-Bench Multilingual with just 3 billion active parameters. Apache 2.0. Local-deployable. We review the architecture, benchmarks, and what the parameter efficiency story means for teams building coding agents.

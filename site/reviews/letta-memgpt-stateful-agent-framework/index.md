...
> Letta reviewed: the only major agent framework where long-term memory management is the primary design goal. Three-tier memory architecture, persistent stateful agents, 9 agent types, MCP client, 15+ LLM providers. 22K stars, Apache 2.0, Python, v0.16.7. Rating: 4/5.

...
> FastMCP is the dominant Python framework for building MCP servers and clients. 24.7K GitHub stars, 27M+ PyPI downloads per week, decorator-based API, proxy servers, OpenAPI providers, and OAuth support. Created by Prefect's CEO.

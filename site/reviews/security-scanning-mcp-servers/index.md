...
> Security scanning MCP servers surge: SonarQube surges 442→544 stars +23% with native cloud MCP, Snyk acquires Invariant Labs → Agent Scan 2.3k stars meta-security, StackHawk FIRST DAST MCP, Checkmarx enters with agentic platform, Black Duck Polaris MCP, Veracode community servers close enterprise gap. Rating upgraded 3.5→4/5.

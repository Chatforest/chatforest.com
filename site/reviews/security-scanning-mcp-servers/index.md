...
> Security scanning MCP servers are vendor-driven: Semgrep (641 stars, built into CLI, 7 tools, SAST/SCA/Secrets), SonarQube (442 stars, Java, code analysis), CodeQL community (143

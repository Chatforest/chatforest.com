...
> OpenLLMetry (Traceloop) reviewed: open-source OTel-native instrumentation for LLM apps. 7K stars, Apache 2.0, Python/JS, v0.60.0. 31 instrumentation packages, 3.85M downloads/month. Acquired by ServiceNow March 2026. Rating: 3.5/5.

...
> The Oxylabs MCP Server combines a traditional Web Scraper API with AI-powered extraction tools in a single Python package. 94 GitHub stars, MIT license, 8 tools across two modes.

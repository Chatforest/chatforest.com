...
> The official dbt MCP server connects AI agents to dbt projects via the Model Context Protocol — data discovery, semantic layer queries, lineage, CLI execution, and code generation. Community alternatives reviewed.

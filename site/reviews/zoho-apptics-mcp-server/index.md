...
> The Zoho Apptics MCP server exposes 14 tools for mobile and product analytics: crash diagnostics, event analytics, screen flow analysis, API performance, and device tracking — deployed locally via npm or accessed as a cloud-hosted remote MCP.

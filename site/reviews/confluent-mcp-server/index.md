...
> Confluent's official MCP server exposes 52 tools across Kafka topics, Flink SQL, Schema Registry, Kafka Connect, Tableflow, and billing — but nearly all require Confluent Cloud.

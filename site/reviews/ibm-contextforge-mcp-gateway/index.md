...
> IBM ContextForge reviewed: an open source MCP gateway, registry, and proxy federating any MCP, A2A, or REST/gRPC API into a unified endpoint with RBAC, TOON compression, 40+ plugins, and Kubernetes HA. Apache-2.0. Rating: 4.0/5.

...
> Apple signed a ~$1B/year deal with Google to power Siri with a custom Gemini model. It puts Gemini on 1.5 billion iOS devices — and lands squarely in the middle of an active DOJ antitrust case.

...
1. Human intelligence is built on learning efficiently from sparse experience, not on pattern-matching over vast corpora.
2. LLMs cannot do this. They require massive data; they cannot learn in context the way infants do.
3. Therefore, scaling LLMs further is not a path to AGI. A paradigm shift is required.
4. Without a paradigm shift, the singularity framing is premature.

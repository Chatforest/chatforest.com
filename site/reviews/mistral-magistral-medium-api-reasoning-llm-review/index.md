...
> Magistral Medium (June 10, 2025) is Mistral AI's first proprietary reasoning model. API-only, 40K context, AIME 2024 73.6% (pass@1), AIME @64 90.0%, GPQA Diamond 70.83%. $2.00/$5.00 per million tokens. The teacher model behind Magistral Small. Rating: 3.5/5.

...
> Zoho DataPrep's MCP server connects AI agents to a full ETL pipeline management layer: create and run pipelines, schedule jobs, manage connections, and debug failures — entirely through conversation.

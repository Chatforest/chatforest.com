...
> Mistral NeMo (July 18, 2024) is a 12.2B parameter language model built jointly by Mistral AI and NVIDIA. 128K context window, new Tekken tokenizer with 2–3× better multilingual compression, Apache 2.0, FP8-ready. MMLU 68.0%, HellaSwag 83.5%. Runs at ~7 GB VRAM. Ollama: mistral-nemo. Rating: 4/5.

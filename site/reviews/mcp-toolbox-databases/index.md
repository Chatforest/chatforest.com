...
> Google's MCP Toolbox for Databases connects AI agents to 40+ data sources with prebuilt tools, YAML-based configuration, OAuth 2.1 auth, and OpenTelemetry observability. 14.7K GitHub stars.

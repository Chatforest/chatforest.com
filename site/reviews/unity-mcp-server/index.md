...
> Unity MCP Server by CoplayDev (Justin Barnett) connects AI agents directly to the Unity Editor. 8.7K GitHub stars, 36+ tools for scene management, asset operations, scripting, physics, profiling, and more. The most popular game engine MCP server.

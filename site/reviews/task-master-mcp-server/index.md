...
> Task Master turns PRDs into structured task lists with dependencies, complexity analysis, and multi-model AI support — a project manager for your AI coding agent.

...
- **Series B** (2022): **$35M** led by **Peak XV Partners** (formerly Sequoia Capital India) and **Tiger Global Management**
...
1. **Script generation**: The agent generates a script optimized for the topic and target platform (YouTube, TikTok, Instagram Reels, LinkedIn, etc.). SEO structure and pacing are baked in.

2. **Visual sourcing**: The agent searches InVideo's library of **16 million+ stock images and videos** and selects clips matching the script's emotional tone and topic keywords. It acts as a director, making editorial decisions about B-roll sequencing.

3. **Voiceover**: AI voiceover in any of **50+ languages**. Users can upload a 30-second audio sample to create a **voice clone** — two clones on Plus plans, five on Max.

4. **Subtitles, transitions, background music**: Added automatically.

5. **Export**: Multi-format export for different platform aspect ratios and resolution requirements.
...
- **Sora 2** (OpenAI) — InVideo became the first platform to offer unrestricted global access to Sora 2, removing waitlists, invite codes, VPN requirements, and 10-second clip limits. Integration announced October 2025.
...
1. **Task creation and management**: Create, update, and manage InVideo video projects using natural language.
2. **Content generation and updating**: Trigger video generation through AI conversations, generate scripts, update records.
3. **Workflow automation**: Automate repetitive InVideo workflows, allowing agents to handle routine content production operations.
...
InVideo's user metrics are substantial:
...
*Research note: ChatForest reviews are based on publicly available information, documentation, and independent user reporting. We do not test AI tools hands-on. For official documentation, see [invideo.io](https://invideo.io) and the [MCP server help page](https://help.invideo.io/en/articles/11316042-invideo-model-context-protocol-server).*

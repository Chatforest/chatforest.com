...
> Microsoft's official Azure DevOps MCP server (1.7K stars, TypeScript, v2.7.0) gives AI agents secure access to work items, repos, pipelines, wikis, and test plans — with both local and remote deployment.

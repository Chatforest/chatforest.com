...
> Chinese AI models surged from under 2% to over 60% of OpenRouter token consumption in 18 months. MiniMax M2.5, Kimi K2.6, DeepSeek V3.2, and GLM-5.1 lead on cost (10–20x cheaper than US models) and now beat GPT-5.4 and Claude Opus 4.6 on SWE-Bench Pro.

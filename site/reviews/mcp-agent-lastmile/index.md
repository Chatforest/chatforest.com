...
> mcp-agent reviewed: an Apache-2.0 Python framework from lastmile-ai that implements all Anthropic 'Building Effective Agents' patterns using MCP as its foundation. 8.1K stars. Rating: 4.0/5.

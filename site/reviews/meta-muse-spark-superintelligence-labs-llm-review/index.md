...
> Muse Spark (April 8, 2026) is Meta's first proprietary model from the new Superintelligence Labs. AI Intelligence Index 52 (#4 globally), HLE 39.9% standard / up to 58.4% Contemplating mode, HealthBench Hard 42.8% (#1). Closed-weight, no public API pricing. Free via meta.ai. Rating: 3.5/5.

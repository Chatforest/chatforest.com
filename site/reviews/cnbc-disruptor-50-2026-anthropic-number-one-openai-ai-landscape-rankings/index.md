...
The [2026 CNBC Disruptor 50](https://www.cnbc.com/2026/05/19/2026-cnbc-disruptor-50-rankings-full-list-companies.html), published May 19, put **Anthropic at #1** — the first time the company has led the list. OpenAI dropped to #2. The top five round out as Databricks (#3), Anduril (#4), and Ramp (#5).
...
The trajectory continues. According to [CNBC reporting from May 20](https://www.cnbc.com/2026/05/20/anthropic-revenue-explosive-growth-ipo-profitable-quarter.html), Anthropic is on track for **$10.9 billion in Q2 2026** — a figure that would exceed all of last year's revenue in three months. Anthropic also reported its first operating profit in Q2, the milestone covered [here](/reviews/anthropic-first-profit-q2-2026-claude-code-spacex-colossus-deal/).

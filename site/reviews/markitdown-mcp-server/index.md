...
> MarkItDown MCP Server by Microsoft converts PDFs, Word docs, Excel, PowerPoint, images, and audio to Markdown for AI consumption. Parent repo has 113K GitHub stars. Single-tool MCP server with SSRF vulnerability disclosed. PyPI 25K downloads/week.

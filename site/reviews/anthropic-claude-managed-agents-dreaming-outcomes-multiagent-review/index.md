...
> Anthropic launched Claude Managed Agents in public beta on April 8, 2026, then shipped three major features at Code with Claude SF (May 6): Dreaming, Outcomes, and Multiagent Orchestration. At Code with Claude London (May 19), two enterprise security features followed: self-hosted sandboxes and MCP tunnels. $0.08/session-hour plus standard token costs.

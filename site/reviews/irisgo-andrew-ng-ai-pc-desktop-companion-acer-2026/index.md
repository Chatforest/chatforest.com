...
> IrisGo raised $2.8M from Andrew Ng's AI Fund, Nvidia, and Google to build a desktop AI companion that learns your workflows by watching you once. Acer is its first OEM partner. The bet: on-device AI that understands your context before you ask.

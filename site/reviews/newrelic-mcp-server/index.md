...
The server works with [Claude, Cursor, VS Code (GitHub Copilot), ChatGPT](https://newrelic.com/blog/news/new-relic-ai-mcp-server-launch), Google's Gemini CLI, and other MCP clients.

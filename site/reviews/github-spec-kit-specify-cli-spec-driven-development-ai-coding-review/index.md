...
> GitHub Spec Kit (github/spec-kit) is an MIT-licensed CLI toolkit with 107K stars that structures AI-assisted coding into a repeatable specify → plan → tasks → implement workflow. Works with 30+ AI coding agents including Claude Code, Copilot, Cursor, and Gemini CLI.

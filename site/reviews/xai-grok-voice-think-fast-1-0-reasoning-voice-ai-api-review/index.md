...
> Grok Voice Think Fast 1.0 (April 25, 2026) is xAI's enterprise voice AI API. End-to-end architecture, background reasoning while speaking, 67.3% on τ-voice Bench (#1), $0.05/min, OpenAI Realtime API compatible. Rating: 4/5.

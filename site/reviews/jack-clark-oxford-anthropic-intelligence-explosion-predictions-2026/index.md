...
> Anthropic co-founder Jack Clark delivered a landmark Oxford lecture on May 21 laying out a compressed timeline for AI's next moves — and acknowledged the extinction risk hasn't gone away. A review of the predictions, the safety framing, and what Anthropic is actually doing about it.
...
The same week, the Anthropic Institute released a formal research agenda on intelligence explosion dynamics — moving recursive self-improvement from theoretical speculation to institutional planning. Part of our **[AI Industry Analysis](/categories/ai-tools/)** coverage.
...
**Related coverage:** [Claude Mythos Preview — The AI Anthropic Won't Release](/reviews/claude-mythos-preview-anthropic-cybersecurity-ai-too-powerful-to-release/) · [Anthropic's Race to $1 Trillion](/reviews/anthropic-900-billion-valuation-30b-round-2026-guide/) · [DeepSeek V4 — Open-Weight Frontier](/reviews/deepseek-v4-open-weight-llm-review/) · [OpenAI Solves 80-Year Erdős Geometry Problem](/reviews/openai-erdos-unit-distance-proof-math-ai-breakthrough-2026/)

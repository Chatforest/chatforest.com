...
[Full breakdown of the terms and what they mean →](/reviews/anthropic-900-billion-valuation-30b-round-2026-guide/)

---

## June 1 — NVIDIA GTC Taipei

**Where:** Taipei Music Center, Taiwan
**Keynote time:** 11:00 a.m. Taipei Standard Time (May 31, 8:00 p.m. PT / 11:00 p.m. ET)
**Livestream:** [nvidia.com/en-tw/gtc/taipei/keynote](https://www.nvidia.com/en-tw/gtc/taipei/keynote/)
...
[Detailed preview of every expected announcement →](/reviews/nvidia-gtc-taipei-2026-jensen-huang-keynote-n1x-vera-rubin-physical-ai-preview/)
...
**Keynote:** June 2, streaming free at [build.microsoft.com](https://build.microsoft.com)
**Expected attendees:** ~2,500 in-person developers
...
[Full preview of what developers should watch →](/reviews/microsoft-build-2026-preview-san-francisco-ai-agents-azure/)
...
**Keynote:** June 8, 10:00 a.m. PT
**Streaming:** [apple.com/apple-events](https://www.apple.com/apple-events/) (free)
...
[Deep preview of every expected Apple AI announcement →](/reviews/apple-wwdc-2026-siri-overhaul-ios-27-apple-intelligence-preview/)
...
**Where:** Tokyo, Japan
**Format:** In-person (applications closed) + livestream
**Register for virtual access:** [claude.com/code-with-claude/tokyo](https://claude.com/code-with-claude/tokyo)
...
**What to expect:**
The Tokyo event typically aligns with model or tooling announcements intended for developer audiences in Asia-Pacific. Given the sequence — San Francisco showed Claude 4 tooling, London went deeper on MCP and multi-agent patterns — Tokyo may emphasize deployment patterns and enterprise integration.

If Anthropic has something to ship for the API or Claude Code, Code with Claude Tokyo is a natural moment to announce it.

[Code with Claude 2026 SF and London recap →](/reviews/code-with-claude-2026-sf-london-developer-conference-recap/)
...
**Exchange:** Nasdaq
**Ticker:** SPCX
**Pricing:** June 11 (after market close)
**Trading debut:** June 12
...
[Platform-by-platform retail IPO access guide →](/reviews/spacex-ipo-spcx-retail-investor-guide-how-to-buy-2026/)

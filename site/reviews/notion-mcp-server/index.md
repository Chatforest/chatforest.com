...
> Notion 3.5 (May 13) ships 91% MCP token efficiency gains, Meeting Notes support, and a full Developer Platform — but the npm package is frozen at v2.2.1, open issues grew to 139, OAuth callback failures hit 16 comments with no fix, and path traversal (CVSS 7.7) remains unpatched.

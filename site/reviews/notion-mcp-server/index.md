...
> Notion offers two official MCP servers: a hosted OAuth-based remote server and an open-source local server via npm (v2.2.1). Notion 3.4 Part 2 brings cheaper Custom Agents, n8n integration, and MCP reliability improvements — but 127 open issues and OAuth instability persist.

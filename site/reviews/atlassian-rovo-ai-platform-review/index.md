...
> Atlassian Rovo is the AI umbrella across Jira, Confluence, and Bitbucket: Search, Chat, Agents, Studio, Dev, and the new Max reasoning mode. It's bundled into every paid Atlassian plan — and 90%+ of enterprise cloud customers are already using it.

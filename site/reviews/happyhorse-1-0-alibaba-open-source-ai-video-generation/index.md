# HappyHorse-1.0 Review — Alibaba's Open-Source #1-Ranked AI Video Model That Launched Anonymously

> HappyHorse-1.0 topped the Artificial Analysis Video Arena in April 2026 before anyone knew Alibaba built it. Holding the #1 ELO spot in silent text-to-video (1,357) and image-to-video (1,397) categories, this 15B-parameter open-source model delivers native joint audio-video synthesis, 7-language lip-sync, and 1080p output. API access via fal.ai at $0.28/s. No official MCP server. Rating 4/5.

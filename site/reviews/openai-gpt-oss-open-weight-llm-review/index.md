...
> gpt-oss-120b and gpt-oss-20b (August 5, 2025) are OpenAI's first open-weight language models since GPT-2 — Apache 2.0, MoE architecture, 128K context, with 120b matching o4-mini on core benchmarks while running on a single GPU.

...
> apify/mcpc reviewed: a lightweight TypeScript CLI client for MCP servers with persistent named sessions, OAuth 2.1, credential sandboxing, progressive tool discovery, and JSON output for AI code agents. Apache-2.0. Rating: 3.5/5.

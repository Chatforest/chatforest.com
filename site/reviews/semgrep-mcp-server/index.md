...
> Semgrep's MCP server and plugin give AI coding agents real-time security scanning — catching vulnerabilities, supply chain risks, and leaked secrets in generated code before it ships.

...
> Salesforce's official Data 360 MCP server (forcedotcom/d360-mcp-server) wraps 187 Data Cloud REST operations behind a three-tool facade. Java/Spring Boot, STDIO, developer preview. We review the architecture, coverage, and limitations.

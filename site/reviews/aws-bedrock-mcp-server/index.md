...
> AWS operates the largest official MCP server collection: 54 open-source servers plus a managed GA remote server, covering databases, compute, security, cost management, and more.

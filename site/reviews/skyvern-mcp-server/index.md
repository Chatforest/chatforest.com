...
> Skyvern's MCP server gives AI agents browser automation powered by computer vision — no brittle selectors, no breaking when UIs change. 21.7K GitHub stars, SOC2+HIPAA compliant, v1.0.36. 75+ tools for form filling, web scraping, and workflow automation.

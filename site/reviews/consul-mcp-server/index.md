...
> HashiCorp's official Consul MCP server exposes 50+ read-only tools across 15 toolsets covering service discovery, KV store, ACLs, Connect service mesh, sessions, peering, and cluster operations. Works with self-managed Consul CE and Enterprise.

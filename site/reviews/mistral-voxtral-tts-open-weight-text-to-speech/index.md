...
> Mistral's 4B-parameter TTS model beats ElevenLabs Flash v2.5 at voice cloning with 3-second reference audio, runs on a single 16 GB GPU, and costs $0.016/1k characters.

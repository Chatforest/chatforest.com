# ETL & Data Integration MCP Servers — Airbyte, Fivetran, dbt Labs, Zoho DataPrep, and More

> MCP servers for ETL pipelines, ELT data integration, and data transformation. Covers Airbyte, Fivetran, dbt Labs, and Zoho DataPrep — with ratings, tool inventories, and architecture comparisons.

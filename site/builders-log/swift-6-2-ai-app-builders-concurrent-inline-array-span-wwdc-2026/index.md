...
> Swift 6.2 ships with Xcode 17 at WWDC 2026. Here is what actually changes for developers building AI features with Foundation Models: @concurrent parallelism, InlineArray for embedding vectors, Span for streaming token buffers, named tasks for debugging, and simplified MainActor usage.

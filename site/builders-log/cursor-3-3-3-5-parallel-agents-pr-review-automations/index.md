...
> Cursor 3.3 ships parallel agent execution and a full PR review loop inside the IDE. Cursor 3.5 adds multi-repo automations and no-code agent templates for Slack, Stripe, and Databricks. Two releases in three weeks, same direction: the editor is becoming the control plane.

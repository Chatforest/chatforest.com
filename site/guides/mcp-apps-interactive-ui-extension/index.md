...
> MCP's first official extension lets servers render interactive dashboards, forms, and visualizations inside AI conversations. Ten launch partners shipped on day one. Here's how it works, who's using it, and what it means for MCP's future.

...
> A comprehensive guide to MCP integrations for construction and architecture — covering BIM (Revit, ArchiCAD, IFC), CAD (AutoCAD, Rhino, SketchUp), project management (Procore)

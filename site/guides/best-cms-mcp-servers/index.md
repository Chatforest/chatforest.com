...
> WordPress, Contentful, Sanity, Strapi, Directus, Ghost, Webflow, Shopify, Wix, and more — we've reviewed 40+ CMS MCP servers across 6 categories. Shopify and Wix now have official MCP servers, EmDash hit 9,400+ stars in two weeks, and WordPress/mcp-adapter v0.5.0 shipped.

...
> Datadog's engineering team rebuilt their MCP server after watching AI agents fail with thin API wrappers. Their design lessons — token-budget pagination, CSV over JSON, query-first tools — apply to anyone building MCP servers for production.

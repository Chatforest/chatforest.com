...
> Six protocols now define how AI agents access tools, collaborate, transact, discover each other, and pay for services. We map the full stack — MCP, A2A, ACP, UCP, ANP, x402 — and explain which layers you actually need.

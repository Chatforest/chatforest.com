...
> A practical guide to MCP elicitation — the protocol feature that lets servers pause tool execution and ask users for information. Covers form mode, URL mode, security rules, and client support.
